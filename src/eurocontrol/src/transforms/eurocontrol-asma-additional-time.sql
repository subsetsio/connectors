...
-- caution: Monthly ASMA additional-time rows are airport-month observations; compare with daily traffic tables only after matching time granularity.
SELECT
...
FROM "eurocontrol-asma-additional-time"
