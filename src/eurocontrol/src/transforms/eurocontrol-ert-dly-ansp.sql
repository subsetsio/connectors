...
-- caution: Rows are the ANSP/AUA view of en-route ATFM delay; cause-code delay columns are components of the reported delay context, not separate independent observations.
SELECT
