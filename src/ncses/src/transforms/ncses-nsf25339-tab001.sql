...
SELECT
    ...
    "Other general support for S and Ea" AS other_general_support_for_s_and_ea,
    "Other S and E activitiesa" AS other_s_and_e_activitiesa
FROM "ncses-nsf25339-tab001"
