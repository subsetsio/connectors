...
-- caution: T-100 international segment rows for US carriers mix carrier, geography, aircraft, service class, and period dimensions; filter the dimensions before aggregating measures.
SELECT
