...
-- caution: T-100 market rows for US carriers mix carrier, market, aircraft, service class, and period dimensions; filter the dimensions before aggregating measures.
SELECT
