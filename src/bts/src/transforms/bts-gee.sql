...
-- caution: T-100 domestic segment rows mix carrier, segment, aircraft, service class, and period dimensions; filter the dimensions before aggregating measures.
SELECT
