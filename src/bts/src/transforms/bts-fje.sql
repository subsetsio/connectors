...
-- caution: T-100 international segment rows mix carrier, geography, aircraft, service class, and period dimensions; filter the dimensions before aggregating measures.
SELECT
