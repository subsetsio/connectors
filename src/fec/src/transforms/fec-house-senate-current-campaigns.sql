...
-- caution: This is a live-cycle House and Senate summary that overlaps with the broader candidate summary table; use it for current-cycle recency rather than combining it with candidate summary totals.
SELECT
