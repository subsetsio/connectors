...
-- caution: The military-service breakdowns of persons naturalized were not collected in every year; `value` is null in those years rather than zero.
...
SELECT
    ...
    "value",
    "value_note"
FROM "dhs-naturalizations-table-21"
