...
-- caution: `category` is the month of arrival, October 2023 through September 2024 — the twelve months of fiscal year 2024 — plus a 'Total' row.
...
SELECT
    ...
    "value",
    "value_note"
FROM "dhs-nonimmigrants-table-32"
