...
-- caution: `breakdown` names only the leading members and lumps the rest into 'All other countries', so its members are not the full universe.
-- caution: `description` is the long name of the class-of-admission code in `category`, repeated on every row of that class.
...
SELECT
    ...
    "value",
    "value_note"
FROM "dhs-nonimmigrants-nisupptable2"
