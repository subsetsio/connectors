...
SELECT
    ...
    CAST("frekvence_cis" AS BIGINT) AS frekvence_cis,
    CAST("frekvence_kod" AS BIGINT) AS frekvence_kod,
    ...
    "uzemi_txt",
    "uzemi_typ"
FROM "czech-statistical-office-sldb2021-vyjizdka-pracoviste-frekvence-pohlavi"
