...
SELECT
    ...
    CAST("obydlenost_cis" AS BIGINT) AS obydlenost_cis,
    CAST("obydlenost_kod" AS BIGINT) AS obydlenost_kod,
    ...
    "uzemi_txt",
    "uzemi_typ"
FROM "czech-statistical-office-sldb2021-byty-obydlenost-druhdomu"
