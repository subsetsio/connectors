...
SELECT
    ...
    CAST("druh_regpobytu_cis" AS BIGINT) AS druh_regpobytu_cis,
    CAST("druh_regpobytu_kod" AS BIGINT) AS druh_regpobytu_kod,
    ...
    "uzemi_txt",
    "uzemi_typ"
FROM "czech-statistical-office-sldb2021-druhregpobyt-pohlavi"
