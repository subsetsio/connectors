...
SELECT
    ...
    CAST("vodovod_cis" AS BIGINT) AS vodovod_cis,
    CAST("vodovod_kod" AS BIGINT) AS vodovod_kod,
    CAST("vodovod_cleneni" AS BIGINT) AS vodovod_cleneni,
    ...
    "uzemi_txt",
    "uzemi_typ"
FROM "czech-statistical-office-sldb2021-obydomy-druh-vodovod"
