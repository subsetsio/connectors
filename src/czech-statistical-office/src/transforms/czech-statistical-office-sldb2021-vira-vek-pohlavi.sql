...
SELECT
    ...
    CAST("vira_cis" AS BIGINT) AS vira_cis,
    CAST("vira_kod" AS BIGINT) AS vira_kod,
    CAST("vira_cleneni" AS BIGINT) AS vira_cleneni,
    ...
    "pohlavi_txt",
    "uzemi_txt"
FROM "czech-statistical-office-sldb2021-vira-vek-pohlavi"
