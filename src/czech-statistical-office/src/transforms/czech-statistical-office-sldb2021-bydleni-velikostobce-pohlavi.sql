...
SELECT
    ...
    CAST("bydleni_cis" AS BIGINT) AS bydleni_cis,
    CAST("bydleni_kod" AS BIGINT) AS bydleni_kod,
    CAST("bydleni_cleneni" AS BIGINT) AS bydleni_cleneni,
    CAST("velikostobce_cis" AS BIGINT) AS velikostobce_cis,
    CAST("velikostobce_kod" AS BIGINT) AS velikostobce_kod,
    ...
    "pohlavi_txt",
    "uzemi_txt"
FROM "czech-statistical-office-sldb2021-bydleni-velikostobce-pohlavi"
