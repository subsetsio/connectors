...
SELECT
    ...
    CAST("misto_regpobytu_cis" AS BIGINT) AS misto_regpobytu_cis,
    CAST("misto_regpobytu_kod" AS BIGINT) AS misto_regpobytu_kod,
    ...
    "uzemi_txt",
    "uzemi_typ"
FROM "czech-statistical-office-sldb2021-mistoregpobyt-pohlavi"
