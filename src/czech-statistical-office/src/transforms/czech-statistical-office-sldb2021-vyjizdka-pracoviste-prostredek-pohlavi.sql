...
SELECT
    ...
    CAST("prostredek_cis" AS BIGINT) AS prostredek_cis,
    CAST("prostredek_kod" AS BIGINT) AS prostredek_kod,
    ...
    "uzemi_txt",
    "uzemi_typ"
FROM "czech-statistical-office-sldb2021-vyjizdka-pracoviste-prostredek-pohlavi"
