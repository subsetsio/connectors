...
SELECT
    ...
    CAST("narodnost_cis" AS BIGINT) AS narodnost_cis,
    CAST("narodnost_kod" AS BIGINT) AS narodnost_kod,
    ...
    "pohlavi_txt",
    "uzemi_txt"
FROM "czech-statistical-office-sldb2021-narodnost-vek-pohlavi"
