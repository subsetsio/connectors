...
-- caution: Annual parasite incidence values are admin 2 estimates; do not sum them with admin 1 or admin 3 tables.
SELECT
    "id",
    "iso_3_code",
    "iso_2_code",
    ...
    "_bbox" AS bbox
FROM "malaria-atlas-project-map-reader:map-data-estate-detail-admin2-api-mean-all"
