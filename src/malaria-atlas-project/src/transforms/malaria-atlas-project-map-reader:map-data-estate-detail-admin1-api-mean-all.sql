...
-- caution: Annual parasite incidence values are admin 1 estimates; do not sum them with admin 2 or admin 3 tables.
SELECT
    "id",
    "iso_3_code",
    "iso_2_code",
    ...
    "_bbox" AS bbox
FROM "malaria-atlas-project-map-reader:map-data-estate-detail-admin1-api-mean-all"
