...
DOWNLOAD_SPECS = [
    NodeSpec(id="noaa-northeast-snowfall-impact-scale", fn=fetch_nesis, kind="download"),
]
...
TRANSFORM_SPECS = [
    SqlNodeSpec(
        id="noaa-northeast-snowfall-impact-scale-transform",
        deps=["noaa-northeast-snowfall-impact-scale"],
        sql=_SQL,
    ),
]
