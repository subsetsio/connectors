...
SELECT
    ...
    "number_of_residents_that_applied_for_the_nycha_resident_training_academy",
    "were_accepted_and_enrolled",
    "were_placed_into_fulltime_or_parttime_jobs",
    "average_wage_of_such_residents_1",
    "enrolled_in_financial_counseling_servicesworkshops_through_the_rees_zone_partner_program",
