...
SELECT
    "staten_island_condominium_property_boroblocklot",
    "staten_island_condominium_property_condo_section",
    "staten_island_condominium_property_address",
    "borough",
    "postcode",
    "latitude",
    "longitude",
    ...
    "bbl",
    "nta",
    "staten_island_condominium_property_neighborhood",
    "staten_island_condominium_property_building_classification",
    "staten_island_condominium_property_total_units",
    "staten_island_condominium_property_year_built",
    "staten_island_condominium_property_gross_sqft",
    ...
    "staten_island_condominium_property_market_value_per_sqft",
