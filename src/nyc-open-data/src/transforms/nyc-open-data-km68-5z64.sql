...
SELECT
    ...
    "receiving_required_amount_of_physical_education_instruction",
    "of_students_who_are_receiving_less_than_the_required_amount_of_physical_education_instruction",
    "receiving_less_than_required_amount_of_physical_education_instruction",
    "of_students_who_have_an_iep_that_recommends_adaptive_physical_education",
    "students_with_iep_that_recommends_adaptive_physical_education"
FROM "nyc-open-data-km68-5z64"
