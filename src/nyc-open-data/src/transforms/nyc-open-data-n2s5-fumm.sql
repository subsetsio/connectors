...
SELECT
    "bronx_condominium_property_boroblocklot",
    "bronx_condominium_property_condo_section",
    "bronx_condominium_property_address",
    "borough",
    "postcode",
    "latitude",
    "longitude",
    ...
    "bbl",
    "nta",
    "bronx_condominium_property_neighborhood",
    "bronx_condominium_property_building_classification",
    "bronx_condominium_property_total_units",
    "bronx_condominium_property_year_built",
    "bronx_condominium_property_gross_sqft",
    "bronx_condominium_property_est_gross_income",
    "bronx_condominium_property_gross_income_per_sqft",
    "bronx_condominium_property_full_market_value",
    "bronx_condominium_property_market_value_per_sqft",
