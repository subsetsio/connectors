...
SELECT
    "brooklyn_condominium_property_boroblocklot",
    "brooklyn_condominium_property_condo_section",
    "brooklyn_condominium_property_address",
    "borough",
    "postcode",
    "latitude",
    "longitude",
    ...
    "bbl",
    "nta",
    "brooklyn_condominium_property_neighborhood",
    "brooklyn_condominium_property_building_classification",
    "brooklyn_condominium_property_total_units",
    "brooklyn_condominium_property_year_built",
    "brooklyn_condominium_property_gross_sqft",
    "brooklyn_condominium_property_est_gross_income",
    "brooklyn_condominium_property_gross_income_per_sqft",
    "brooklyn_condominium_property_full_market_value",
    "brooklyn_condominium_property_market_value_per_sqft",
