...
SELECT
    ...
    "CD_TPH_LVL_1" AS cd_tph_lvl_1,
    "TX_TPH_DESCR_FR_LVL_1" AS tx_tph_descr_fr_lvl_1,
    "TX_TPH_DESCR_NL_LVL_1" AS tx_tph_descr_nl_lvl_1,
    "CD_TPH_LVL_2" AS cd_tph_lvl_2,
    "TX_TPH_DESCR_FR_LVL_2" AS tx_tph_descr_fr_lvl_2,
    "TX_TPH_DESCR_NL_LVL_2" AS tx_tph_descr_nl_lvl_2,
    CAST("MS_MENAGES" AS BIGINT) AS ms_menages
FROM "statbel-nodeid5689"
