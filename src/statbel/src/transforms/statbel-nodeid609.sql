...
SELECT
    ...
    "CD_SIE_LVL_0" AS cd_sie_lvl_0,
    "CD_SIE_LVL_1" AS cd_sie_lvl_1,
    "TX_SIE_DESCR_FR_LVL_1" AS tx_sie_descr_fr_lvl_1,
    "TX_SIE_DESCR_NL_LVL_1" AS tx_sie_descr_nl_lvl_1,
    "CD_SIE_LVL_2" AS cd_sie_lvl_2,
    "TX_SIE_DESCR_FR_LVL_2" AS tx_sie_descr_fr_lvl_2,
    "TX_SIE_DESCR_NL_LVL_2" AS tx_sie_descr_nl_lvl_2,
