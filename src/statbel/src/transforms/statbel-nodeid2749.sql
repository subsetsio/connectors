...
SELECT
    ...
    CAST("MS_VICT" AS BIGINT) AS ms_vict,
    CAST("MS_VIC_OK" AS BIGINT) AS ms_vic_ok,
    CAST("MS_SLY_INJ" AS BIGINT) AS ms_sly_inj,
    CAST("MS_SERLY_INJ" AS BIGINT) AS ms_serly_inj,
    CAST("MS_DEAD_30_DAYS" AS BIGINT) AS ms_dead_30_days,
    ...
    CAST("CD_VICT_TYPE" AS BIGINT) AS cd_vict_type,
    "TX_VICT_TYPE_DESCR_FR" AS tx_vict_type_descr_fr,
    "TX_VICT_TYPE_DESCR_NL" AS tx_vict_type_descr_nl,
    "CD_ROAD_USER_TYPE" AS cd_road_user_type,
    "TX_ROAD_USR_TYPE_DESCR_FR" AS tx_road_usr_type_descr_fr,
    "TX_ROAD_USR_TYPE_DESCR_NL" AS tx_road_usr_type_descr_nl,
    ...
    CAST("CD_LIGHT_COND" AS BIGINT) AS cd_light_cond,
    "TX_LIGHT_COND_DESCR_FR" AS tx_light_cond_descr_fr,
    "TX_LIGHT_COND_DESCR_NL" AS tx_light_cond_descr_nl,
    CAST("CD_AGE_CLS" AS BIGINT) AS cd_age_cls,
    "TX_AGE_CLS_DESCR_FR" AS tx_age_cls_descr_fr,
    "TX_AGE_CLS_DESCR_NL" AS tx_age_cls_descr_nl,
