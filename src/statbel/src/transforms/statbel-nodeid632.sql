...
SELECT
    ...
    "TX_GEO_DESCR_FR_LVL_0" AS tx_geo_descr_fr_lvl_0,
    "TX_GEO_DESCR_NL_LVL_0" AS tx_geo_descr_nl_lvl_0,
    ...
    "CD_COC_LVL_3" AS cd_coc_lvl_3,
    "TX_COC_DESCR_FR_LVL_3" AS tx_coc_descr_fr_lvl_3,
    "TX_COC_DESCR_NL_LVL_3" AS tx_coc_descr_nl_lvl_3,
    "CD_COC_LVL_4" AS cd_coc_lvl_4,
    "TX_COC_DESCR_FR_LVL_4" AS tx_coc_descr_fr_lvl_4,
    "TX_COC_DESCR_NL_LVL_4" AS tx_coc_descr_nl_lvl_4,
    ...
    "CD_YAT_LVL_0" AS cd_yat_lvl_0,
    "CD_YAT_LVL_1" AS cd_yat_lvl_1,
    "TX_YAT_DESCR_FR_LVL_1" AS tx_yat_descr_fr_lvl_1,
    "TX_YAT_DESCR_NL_LVL_1" AS tx_yat_descr_nl_lvl_1,
