...
SELECT
    ...
    "CD_AGE_LVL_3" AS cd_age_lvl_3,
    "TX_AGE_DESCR_FR_LVL_3" AS tx_age_descr_fr_lvl_3,
    "TX_AGE_DESCR_NL_LVL_3" AS tx_age_descr_nl_lvl_3,
