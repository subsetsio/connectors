...
SELECT
    ...
    "CD_GEO_LVL_4" AS cd_geo_lvl_4,
    "TX_GEO_DESCR_FR_LVL_4" AS tx_geo_descr_fr_lvl_4,
    "TX_GEO_DESCR_NL_LVL_4" AS tx_geo_descr_nl_lvl_4,
    "CD_TLQ_LVL_0" AS cd_tlq_lvl_0,
    "CD_TLQ_LVL_1" AS cd_tlq_lvl_1,
    "TX_TLQ_DESCR_FR_LVL_1" AS tx_tlq_descr_fr_lvl_1,
    "TX_TLQ_DESCR_NL_LVL_1" AS tx_tlq_descr_nl_lvl_1,
    CAST("OBS_VALUE" AS BIGINT) AS obs_value
FROM "statbel-nodeid667"
