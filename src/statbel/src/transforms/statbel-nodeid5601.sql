...
SELECT
    ...
    "CD_LMS_LVL_1" AS cd_lms_lvl_1,
    "TX_LMS_DESCR_FR_LVL_1" AS tx_lms_descr_fr_lvl_1,
    "TX_LMS_DESCR_NL_LVL_1" AS tx_lms_descr_nl_lvl_1,
    "CD_LMS_LVL_2" AS cd_lms_lvl_2,
    "TX_LMS_DESCR_FR_LVL_2" AS tx_lms_descr_fr_lvl_2,
    "TX_LMS_DESCR_NL_LVL_2" AS tx_lms_descr_nl_lvl_2,
    CAST("MS_POP" AS BIGINT) AS ms_pop
FROM "statbel-nodeid5601"
