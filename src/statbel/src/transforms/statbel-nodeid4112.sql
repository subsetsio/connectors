...
SELECT
    ...
    "CD_STAT_TYPE_NL" AS cd_stat_type_nl,
    "CD_STAT_TYPE_FR" AS cd_stat_type_fr,
    "CD_BUILDING_TYPE" AS cd_building_type,
    "CD_BUILDING_TYPE_NL" AS cd_building_type_nl,
    "CD_BUILDING_TYPE_FR" AS cd_building_type_fr,
    "MS_VALUE" AS ms_value
FROM "statbel-nodeid4112"
