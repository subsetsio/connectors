...
SELECT
    ...
    CAST("Shape__Area" AS DOUBLE) AS shape_area,
    CAST("Shape__Length" AS DOUBLE) AS shape_length
FROM "california-department-of-finance-f49d2d7e35fe47f9aac2fc20e5c0ca43"
