...
SELECT
    ...
    CAST("HEALTH_CONDITION_BLIND" AS BIGINT) AS health_condition_blind,
    "Blindness or partial sight loss" AS blindness_or_partial_sight_loss,
