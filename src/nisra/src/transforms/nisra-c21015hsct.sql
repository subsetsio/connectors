...
SELECT
    ...
    CAST("HEALTH_CONDITION_DEAF" AS BIGINT) AS health_condition_deaf,
    "Deafness or partial hearing loss" AS deafness_or_partial_hearing_loss,
