...
-- caution: Monthly consumer price index rows mix the overall index with purpose-of-use categories; filter the category columns before aggregating.
SELECT
    ...
    "source_table_code",
    "source_row_number"
FROM "statistisches-landesamt-sachsen-anhalt-61111-0002"
