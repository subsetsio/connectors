"""Park Attendance connector — discovers *_SPECS in src/nodes/ and runs the DAG.
...
def main():
    ...
    workflow = load_nodes()
    workflow.run()
    # Model-authored health tests run here so local and cloud runs evaluate the
    # same raw assets after the DAG completes.
