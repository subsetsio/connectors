...
SELECT
    ...
    "enterprises_with_innovation_cooperation_of_which_governm_or_public_research_inst",
    "enterprises_with_innovation_cooperation_of_which_governm_or_public_research_inst_as_of_all_enterpr_with_innov_coop",
    ...
    "enterprises_with_innovation_cooperation_of_which_ngos_as_of_all_enterpr_with_innov_coop",
    "enterprises_with_innovation_cooperation_of_which_consultants_commercial_labs_or_priv_research_enterp",
    "enterprises_with_innovation_cooperation_of_which_consultants_or_commercial_labs_or_priv_research_enterp_as_of_all_enterpr_with_innov_coop",
    "enterprises_with_innovation_cooperation_of_which_suppliers",
    "enterprises_with_innovation_cooperation_of_which_suppliers_as_of_all_enterpr_with_innov_coop",
