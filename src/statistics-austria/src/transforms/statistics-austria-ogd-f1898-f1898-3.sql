...
SELECT
    ...
    "government_sector",
    "government_sector_provincial_hospitals",
    "government_sector_of_which_austrian_academy_of_science",
    ...
    "business_enterprise_sector_of_which_company_rad_sub_sector"
FROM "statistics-austria-ogd-f1898-f1898-3"
