...
SELECT
    ...
    "fallart",
    "nace_2008_3_steller_teilw_abo_teilw_spe_ebene_2",
    ...
    "verlustabzug_eur",
    "fallzahl_verluste_ausl_nd_gruppenmitglieder_abz_gl_nachzuversteuernde_verluste" AS fllzhl_vrlst_asl_nd_grppnmtgldr_abz_gl_nchzvrstrnd_vrlst,
    "verluste_ausl_nd_gruppenmitglieder_abz_gl_nachzuversteuernde_verluste_eur" AS vrlst_asl_nd_grppnmtgldr_abz_gl_nchzvrstrnd_vrlst_er,
...
FROM "statistics-austria-ogd--steuer-kst-kst-2"
