...
SELECT
    ...
    "part_de_la_duree_esperee_d_apa_dans_la_duree_totale_de_retraite_en" AS part_duree_apa_dans_duree_retraite_en,
    "proportion_de_beneficiaires_de_l_apa_au_cours_de_la_retraite_en",
    "age_moyen_a_l_entree_dans_l_apa_pour_ses_beneficiaires",
    "duree_moyenne_de_perception_de_l_apa_pour_ses_beneficiaires_en_annees" AS duree_moyenne_perception_apa_beneficiaires_annees
