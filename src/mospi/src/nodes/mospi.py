...
PLAN = {
    ...
    "nss75e-getnss75records":    ("/api/nss-75/getNSS75Records",
                                  lambda: _by_survey("/api/nss-75/getIndicatorList", (2,))),
    "nss79-getnss79records":     ("/api/nss-79/getNSS79Records",
                                  lambda: _by_survey("/api/nss-79/getNSS79IndicatorList", (1, 2))),
