...
SELECT
    ...
    "PRIVATE EQUITY COMPANY - OWNER" AS private_equity_company_owner,
    "REIT - OWNER" AS reit_owner,
    "CHAIN HOME OFFICE - OWNER" AS chain_home_office_owner,
    "TRUST OR TRUSTEE - OWNER" AS trust_or_trustee_owner,
    "OTHER TYPE - OWNER" AS other_type_owner,
    "OTHER TYPE TEXT - OWNER" AS other_type_text_owner,
    "PARENT COMPANY - OWNER" AS parent_company_owner,
    "OWNED BY ANOTHER ORG OR IND - OWNER" AS owned_by_another_org_or_ind_owner
FROM "cms-afe44b85-cc6d-40d7-b5df-00ae8910d1d2"
