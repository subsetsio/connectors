...
SELECT
    ...
    CAST("How often the home health team began their patients' care in a timely manner" AS DOUBLE) AS how_often_home_health_team_began_their_pts_care_a_timely_manner,
    CAST("How often the home health team determined whether patients received a flu shot for the current flu season" AS DOUBLE) AS how_often_home_health_team_determined_wh_shot_current_flu_season,
    ...
    CAST("How often patients got better at taking their drugs correctly by mouth" AS DOUBLE) AS how_often_pts_got_better_at_taking_thei_drugs_correctly_by_mouth,
    ...
    CAST("How often physician-recommended actions to address medication issues were completely timely" AS DOUBLE) AS how_often_physician_recommended_ac_issues_were_completely_timely,
    CAST("Percent of Residents Experiencing One or More Falls with Major Injury" AS DOUBLE) AS pct_residents_experiencing_one_more_falls_major_injury,
    ...
    CAST("How much Medicare spends on an episode of care by agencies in this state, compared to Medicare spending across all agencies nationally" AS DOUBLE) AS how_much_mcare_spends_on_an_episo_across_all_agencies_nationally
FROM "cms-tee5-ixt5"
