...
SELECT
    ...
    CAST("mode_medicare_pricing_for_established_patient" AS BIGINT) AS mode_medicare_pricing_for_established_patient,
    ...
    CAST("mode_copay_for_established_patient" AS BIGINT) AS mode_copay_for_established_patient,
