...
SELECT
    "COUNTRY" AS country,
    CAST("Lower box percent of patients-nephrologists' communication and caring" AS DOUBLE) AS lower_box_pct_pts_nephrologists_communication_caring,
    CAST("Middle box percent of patients-nephrologists' communication and caring" AS DOUBLE) AS middle_box_pct_pts_nephrologists_communication_caring,
    CAST("Top box percent of patients-nephrologists' communication and caring" AS DOUBLE) AS top_box_pct_pts_nephrologists_communication_caring,
    ...
    CAST("Lower box percent of patients-quality of dialysis center care and operations" AS DOUBLE) AS lower_box_pct_pts_quality_dial_center_care_operations,
    CAST("Middle box percent of patients-quality of dialysis center care and operations" AS DOUBLE) AS middle_box_pct_pts_quality_dial_center_care_operations,
    CAST("Top box percent of patients-quality of dialysis center care and operations" AS DOUBLE) AS top_box_pct_pts_quality_dial_center_care_operations,
    CAST("Linearized score of quality of dialysis center care and operations" AS DOUBLE) AS linearized_score_quality_dial_center_care_operations,
    ...
    CAST("Lower box percent of patients-rating of the dialysis center staff" AS DOUBLE) AS lower_box_pct_pts_rating_dial_center_staff,
    CAST("Middle box percent of patients-rating of the dialysis center staff" AS DOUBLE) AS middle_box_pct_pts_rating_dial_center_staff,
    ...
    CAST("Total number of completed interviews from the Fall and Spring Surveys" AS DOUBLE) AS total_num_completed_interviews_from_fall_spring_surveys,
