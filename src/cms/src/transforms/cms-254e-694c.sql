...
SELECT
    ...
    CAST("mode_medicare_pricing_for_new_patient" AS BIGINT) AS mode_medicare_pricing_for_new_patient,
    ...
    CAST("mode_copay_for_new_patient" AS BIGINT) AS mode_copay_for_new_patient,
