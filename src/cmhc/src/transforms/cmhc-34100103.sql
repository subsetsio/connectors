-- Statistics Canada table 34-10-0103 (CMHC).
...
-- caution: `type_of_unit` mixes subtotals with their components — 'Total - row, apartment and other', 'Total units' overlap the component categories ('Single-detached'); summing across the column double-counts. Pick one level.
