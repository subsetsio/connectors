-- Statistics Canada table 34-10-0142 (CMHC).
...
-- caution: `type_of_unit` mixes subtotals with their components — 'Multiples', 'Total units' overlap the component categories ('Single-detached units'); summing across the column double-counts. Pick one level.
