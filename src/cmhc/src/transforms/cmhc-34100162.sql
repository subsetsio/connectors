-- Statistics Canada table 34-10-0162 (CMHC).
...
-- caution: `type_of_unit` mixes subtotals with their components — 'Row, apartment and other units', 'Single-detached and semi-detached units', 'Total units' overlap the component categories ('Apartment and other units', 'Row units', 'Semi-detached units', 'Single-detached units'); summing across the column double-counts. Pick one level.
SELECT
