...
SELECT
    ...
    CAST("FERT_ASSUMP" AS BIGINT) AS fert_assump,
    CAST("PATERNITY_ASSUMP" AS BIGINT) AS paternity_assump,
    CAST("MORT_ASSUMP" AS BIGINT) AS mort_assump,
...
FROM "australian-bureau-of-statistics-aboriginal-pop-proj"
