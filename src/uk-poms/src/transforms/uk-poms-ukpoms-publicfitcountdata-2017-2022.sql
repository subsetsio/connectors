...
-- caution: Rows are public FIT Count samples with several pollinator group count columns; avoid summing across group columns as if each column were an independent record.
SELECT
...
FROM "uk-poms-ukpoms-publicfitcountdata-2017-2022"
