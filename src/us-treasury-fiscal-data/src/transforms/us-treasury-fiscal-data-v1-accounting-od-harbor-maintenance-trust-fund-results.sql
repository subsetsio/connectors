...
-- caution: Aggregate rows sit alongside the components they sum: `component_desc` ('Total Transfers', 'Total expenses', 'Total receipts'); `line_item_desc` ('Total Transfers', 'Total expenses', 'Total receipts'). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-od-harbor-maintenance-trust-fund-results"
