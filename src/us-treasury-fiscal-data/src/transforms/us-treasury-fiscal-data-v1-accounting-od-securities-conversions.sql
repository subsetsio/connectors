...
SELECT
    "record_date",
    "security_class_desc",
    CAST(NULLIF("paper_sb_conversions_cnt", 'null') AS BIGINT) AS paper_sb_conversions_cnt,
    CAST(NULLIF("paper_sb_conversions_amt", 'null') AS DOUBLE) AS paper_sb_conversions_amt,
...
FROM "us-treasury-fiscal-data-v1-accounting-od-securities-conversions"
