...
SELECT
    ...
    "security_type",
    "security_type_desc",
    CAST(NULLIF("securities_outstanding_cnt", 'null') AS BIGINT) AS securities_outstanding_cnt,
    CAST(NULLIF("principal_outstanding_amt", 'null') AS DOUBLE) AS principal_outstanding_amt,
...
FROM "us-treasury-fiscal-data-v2-accounting-od-slgs-statistics"
