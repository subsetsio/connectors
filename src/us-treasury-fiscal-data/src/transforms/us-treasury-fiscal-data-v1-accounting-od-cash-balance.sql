...
-- caution: Aggregate rows sit alongside the components they sum: `line_item_desc` ('Subtotal - adjustments for non-cash flow amounts in the budget related to federal debt', 'Subtotal - adjustments for non-cash flow amounts in the budget related to federal debt securities', 'Subtotal - adjustments for non-cash flow amounts in the budget related to loan financing account activity', …). Summing an amount column without excluding them double-counts.
...
FROM "us-treasury-fiscal-data-v1-accounting-od-cash-balance"
