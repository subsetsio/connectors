...
SELECT
    "record_date",
    CAST(NULLIF("annualized_effective_rate", 'null') AS DOUBLE) AS annualized_effective_rate,
    CAST(NULLIF("daily_factor", 'null') AS DOUBLE) AS daily_factor,
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-od-slgs-demand-deposit-rates"
