...
-- caution: Aggregate rows sit alongside the components they sum: `line_item_desc` ('Subtotal - components of net operating cost not part of budget deficit', 'Subtotal - components of the budget deficit that are not part of net operating cost', 'Subtotal - excess of accrual-basis expenses over budget outlays', …). Summing an amount column without excluding them double-counts.
...
SELECT
    ...
    "component_desc",
    "line_item_desc",
    CAST(NULLIF("position_bil_amt", 'null') AS DOUBLE) AS position_bil_amt,
...
FROM "us-treasury-fiscal-data-v1-accounting-od-reconciliations"
