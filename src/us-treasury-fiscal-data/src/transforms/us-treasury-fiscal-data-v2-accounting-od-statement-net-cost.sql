...
-- caution: Aggregate rows sit alongside the components they sum: `agency_nm` ('Subtotal', 'Subtotal before loss/(gain) from changes in assumptions in 2010', 'Subtotal of loss/(gain) from changes in assumptions', …). Summing an amount column without excluding them double-counts.
...
FROM "us-treasury-fiscal-data-v2-accounting-od-statement-net-cost"
