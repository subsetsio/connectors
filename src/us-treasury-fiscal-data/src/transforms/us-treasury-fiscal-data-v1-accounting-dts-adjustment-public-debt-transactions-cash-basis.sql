...
SELECT
    ...
    "adj_type",
    "adj_type_desc",
    CAST(NULLIF("adj_today_amt", 'null') AS BIGINT) AS adj_today_amt,
    CAST(NULLIF("adj_mtd_amt", 'null') AS BIGINT) AS adj_mtd_amt,
    CAST(NULLIF("adj_fytd_amt", 'null') AS BIGINT) AS adj_fytd_amt,
    "table_nbr",
    "table_nm",
    "sub_table_name",
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-dts-adjustment-public-debt-transactions-cash-basis"
