...
SELECT
    "record_date",
    "classification",
    CAST(NULLIF("today_amt", 'null') AS BIGINT) AS today_amt,
    CAST(NULLIF("mtd_amt", 'null') AS BIGINT) AS mtd_amt,
    CAST(NULLIF("fytd_amt", 'null') AS BIGINT) AS fytd_amt,
    "table_nbr",
    "table_nm",
    "sub_table_name",
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-dts-inter-agency-tax-transfers"
