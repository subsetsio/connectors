...
-- caution: Aggregate rows sit alongside the components they sum: `component_desc` ('Total Appropriations', 'Total revenue'); `line_item_desc` ('Total Appropriations', 'Total revenue', 'Total, investment revenue', …). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-od-sport-fish-restoration-boating-trust-fund-results"
