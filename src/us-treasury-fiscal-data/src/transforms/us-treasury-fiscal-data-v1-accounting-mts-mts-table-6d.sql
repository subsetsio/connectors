...
-- caution: Aggregate rows sit alongside the components they sum: `classification_desc` ('Grand Total', 'Total Agency Securities', 'Total Federal Funds', …). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    "parent_id",
...
FROM "us-treasury-fiscal-data-v1-accounting-mts-mts-table-6d"
