...
-- caution: Aggregate rows sit alongside the components they sum: `account_desc` ('Total Outlays/transfers'); `component_desc` ('Total Outlays/transfers', 'Total Receipts'). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-od-vaccine-injury-compensation-trust-fund-results"
