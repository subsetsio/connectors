...
SELECT
    ...
    "security_type_desc",
    "security_class_desc",
    CAST(NULLIF("securities_redeemed_cnt", 'null') AS BIGINT) AS securities_redeemed_cnt,
    CAST(NULLIF("securities_redeemed_amt", 'null') AS DOUBLE) AS securities_redeemed_amt,
...
FROM "us-treasury-fiscal-data-v1-accounting-od-securities-redemptions"
