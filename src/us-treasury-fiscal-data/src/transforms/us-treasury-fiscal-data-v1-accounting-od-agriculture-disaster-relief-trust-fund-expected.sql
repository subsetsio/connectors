...
-- caution: Aggregate rows sit alongside the components they sum: `component_desc` ('Total Budgetary Resources', 'Total Budgetary Resources:', 'Total budgetary resources (disc. and mand.)', …). Summing an amount column without excluding them double-counts.
...
SELECT
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-od-agriculture-disaster-relief-trust-fund-expected"
