...
SELECT
    ...
    CAST(NULLIF("gain_amt", 'null') AS DOUBLE) AS gain_amt,
    CAST(NULLIF("loss_amt", 'null') AS DOUBLE) AS loss_amt,
...
FROM "us-treasury-fiscal-data-v1-accounting-od-fbp-gl-repay-advance-balances"
