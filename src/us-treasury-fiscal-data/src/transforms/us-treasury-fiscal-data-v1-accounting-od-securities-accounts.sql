...
SELECT
    "record_date",
    CAST(NULLIF("unrestrict_primary_accts_cnt", 'null') AS BIGINT) AS unrestrict_primary_accts_cnt,
    "funded_accts_cnt",
...
FROM "us-treasury-fiscal-data-v1-accounting-od-securities-accounts"
