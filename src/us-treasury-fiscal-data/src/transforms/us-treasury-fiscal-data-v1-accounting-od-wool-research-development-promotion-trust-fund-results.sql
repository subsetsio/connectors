...
-- caution: Aggregate rows sit alongside the components they sum: `component_desc` ('Total Expenses', 'Total Receipts', 'Total expenses', …). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-od-wool-research-development-promotion-trust-fund-results"
