...
SELECT
    ...
    "security_type_desc",
    "security_class_desc",
    CAST(NULLIF("securities_outstanding_amt", 'null') AS DOUBLE) AS securities_outstanding_amt,
...
FROM "us-treasury-fiscal-data-v1-accounting-od-securities-outstanding"
