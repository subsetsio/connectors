...
-- caution: Aggregate rows sit alongside the components they sum: `classification_desc` ('Total Off-Budget', 'Total On-Budget', 'Total Outlays', …). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    "parent_id",
...
FROM "us-treasury-fiscal-data-v1-accounting-mts-mts-table-5"
