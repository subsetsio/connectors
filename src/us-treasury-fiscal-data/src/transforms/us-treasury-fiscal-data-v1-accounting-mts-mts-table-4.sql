...
-- caution: Aggregate rows sit alongside the components they sum: `classification_desc` ('Total -- Employment and General Retirement', 'Total -- Excise Taxes', 'Total -- Federal Disability Insurance Trust Fund', …). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    "parent_id",
...
FROM "us-treasury-fiscal-data-v1-accounting-mts-mts-table-4"
