...
-- caution: Aggregate rows sit alongside the components they sum: `line_item_desc` ('Total Receipts', 'Total receipts'). Summing an amount column without excluding them double-counts.
...
SELECT
    ...
    "component_desc",
    "line_item_desc",
    CAST(NULLIF("fiscal_year_expected_bil_amt", 'null') AS BIGINT) AS fiscal_year_expected_bil_amt,
    ...
    "record_calendar_day"
FROM "us-treasury-fiscal-data-v1-accounting-od-highway-trust-fund-expected"
