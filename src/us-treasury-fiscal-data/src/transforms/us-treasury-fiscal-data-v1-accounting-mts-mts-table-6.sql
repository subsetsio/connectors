...
-- caution: Aggregate rows sit alongside the components they sum: `classification_desc` ('Total Asset Accounts', 'Total Borrowing from the Public', 'Total Budget and Off-Budget Federal Entities (Financing of Deficit (+) or Disposition of Surplus (-))', …). Summing an amount column without excluding them double-counts.
SELECT
    "record_date",
    "parent_id",
...
FROM "us-treasury-fiscal-data-v1-accounting-mts-mts-table-6"
