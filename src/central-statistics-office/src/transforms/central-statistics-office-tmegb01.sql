...
SELECT
    ...
    "value",
    "dim1_name",
    CAST("dim1_code" AS BIGINT) AS dim1_code,
    "dim1_label",
    "dim2_name",
    CAST("dim2_code" AS BIGINT) AS dim2_code,
    "dim2_label",
    "dim3_name",
    CAST("dim3_code" AS BIGINT) AS dim3_code,
    "dim3_label",
    "dim4_name",
    CAST("dim4_code" AS BIGINT) AS dim4_code,
    "dim4_label",
    "dim5_name",
    "dim5_code",
    "dim5_label",
    ...
    "dim6_code",
    "dim6_label"
FROM "central-statistics-office-tmegb01"
