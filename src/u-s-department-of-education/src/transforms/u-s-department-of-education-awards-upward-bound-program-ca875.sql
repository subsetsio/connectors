...
SELECT
    ...
    "Upward Bound(UB) Grantees" AS upward_bound_ub_grantees,
    "State" AS state,
    ...
    "Upward Bound (UB) Grantees" AS upward_bound_ub_grantees_2,
    ...
    "FY 2011 Base Funding (2011-12 Project Yr)" AS fy_2011_base_funding_2011_12_project_yr,
    "FY 2011 Supplement (2011-12 Project Yr)" AS fy_2011_supplement_2011_12_project_yr,
    "FY 2011 Funding (2011-12 Project Yr)" AS fy_2011_funding_2011_12_project_yr,
    "CCRAA Funding" AS ccraa_funding
FROM "u-s-department-of-education-awards-upward-bound-program-ca875"
