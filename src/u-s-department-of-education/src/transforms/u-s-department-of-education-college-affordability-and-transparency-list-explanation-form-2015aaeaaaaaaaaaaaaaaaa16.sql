...
SELECT
    ...
    "sheet_name",
    "row_number",
    "College Affordability and Transparency Data Files, 2013" AS college_affordability_and_transparency_data_files_2013,
    ...
    "State" AS state,
    "2013-14 Tuition and fees" AS 2013_14_tuition_and_fees,
    ...
    "2012-13 Net price" AS 2012_13_net_price,
    "Percent receiving grant aid 2012-13" AS percent_receiving_grant_aid_2012_13,
...
FROM "u-s-department-of-education-college-affordability-and-transparency-list-explanation-form-2015aaeaaaaaaaaaaaaaaaa16"
