...
SELECT
    ...
    "Upward Bound/Math Science(UBMS) Grantees" AS upward_bound_math_science_ubms_grantees,
    "State" AS state,
    "Number of Participants" AS number_of_participants,
    "FY 2021 Funding (2021-22 Project Yr)" AS fy_2021_funding_2021_22_project_yr,
    "sheet_name",
    "Upward Bound/Math Science (UBMS) Grantees" AS upward_bound_math_science_ubms_grantees_2,
    ...
    "Upward Bound-Math Science (UBMS) Grantees" AS upward_bound_math_science_ubms_grantees_3,
    ...
    "Upward Bound Math-Science (UBMS) Grantees" AS upward_bound_math_science_ubms_grantees_4,
...
FROM "u-s-department-of-education-awards-upward-bound-math-science-program-d1474"
