...
SELECT
    ...
    "Talent Search(TS) Grantees" AS talent_search_ts_grantees,
    "State" AS state,
    ...
    "Talent Search (TS) Grantees" AS talent_search_ts_grantees_2,
...
FROM "u-s-department-of-education-awards-talent-search-program-c35be"
