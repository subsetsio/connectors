...
SELECT
    "Number" AS number,
    "Total" AS total,
    "WithNoIncomeFromWork" AS withnoincomefromwork,
    "MonthlyIncomeFromWorkOfHusband_Below_1_000" AS monthlyincomefromworkofhusband_below_1_000,
...
FROM "sg-data-d-fd3f9a245ed722b88cb6a850f3fbb806"
