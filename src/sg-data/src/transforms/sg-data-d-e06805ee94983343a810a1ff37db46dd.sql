...
SELECT
    "Number" AS number,
    "Total_AgeAtFirstMarriage_Years_Total" AS total_ageatfirstmarriage_years_total,
    ...
    "Chinese_AgeAtFirstMarriage_Years_Total" AS chinese_ageatfirstmarriage_years_total,
    ...
    "Malays_AgeAtFirstMarriage_Years_Total" AS malays_ageatfirstmarriage_years_total,
    ...
    "Indians_AgeAtFirstMarriage_Years_Total" AS indians_ageatfirstmarriage_years_total,
    ...
    "Others_AgeAtFirstMarriage_Years_Total" AS others_ageatfirstmarriage_years_total,
...
FROM "sg-data-d-e06805ee94983343a810a1ff37db46dd"
