...
SELECT
    "Number" AS number,
    "Total" AS total,
    "HDBDwellings_TotalHDB1" AS hdbdwellings_totalhdb1,
    ...
    "Condo_MiniumsAndOtherApartments" AS condo_miniumsandotherapartments,
    "LandedProperties" AS landedproperties,
    "Others" AS others
FROM "sg-data-d-ae8f6f7e9184361a187dd335fa04b684"
