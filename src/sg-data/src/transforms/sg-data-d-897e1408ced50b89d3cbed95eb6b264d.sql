...
SELECT
    ...
    "Total_Condomi_NiumsAndOtherApartments" AS total_condomi_niumsandotherapartments,
    ...
    "Males_Condomi_NiumsAndOtherApartments" AS males_condomi_niumsandotherapartments,
    ...
    "Females_Condomi_NiumsAndOtherApartments" AS females_condomi_niumsandotherapartments,
    "Females_LandedProperties" AS females_landedproperties,
    "Females_Others" AS females_others
FROM "sg-data-d-897e1408ced50b89d3cbed95eb6b264d"
