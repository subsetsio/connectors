...
SELECT
    ...
    CAST("multiple_religions_in_household_7_categories_code" AS BIGINT) AS multiple_religions_in_household_7_categories_code,
    "multiple_religions_in_household_7_categories",
    "value"
FROM "ons-ts075"
