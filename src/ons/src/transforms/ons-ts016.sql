...
SELECT
    ...
    CAST("length_of_residence_in_the_uk_6_categories_code" AS BIGINT) AS length_of_residence_in_the_uk_6_categories_code,
    "length_of_residence_in_the_uk_6_categories",
    "value"
FROM "ons-ts016"
