...
SELECT
    ...
    CAST("method_used_to_travel_to_workplace_12_categories_code" AS BIGINT) AS method_used_to_travel_to_workplace_12_categories_code,
    "method_used_to_travel_to_workplace_12_categories",
    "value"
FROM "ons-ts061"
