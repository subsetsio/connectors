...
SELECT
    ...
    CAST("multiple_main_languages_in_household_6_categories_code" AS BIGINT) AS multiple_main_languages_in_household_6_categories_code,
    "multiple_main_languages_in_household_6_categories",
    "value"
FROM "ons-ts026"
