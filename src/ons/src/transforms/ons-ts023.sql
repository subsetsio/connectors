...
SELECT
    ...
    CAST("multiple_ethnic_groups_in_household_6_categories_code" AS BIGINT) AS multiple_ethnic_groups_in_household_6_categories_code,
    "multiple_ethnic_groups_in_household_6_categories",
    "value"
FROM "ons-ts023"
