...
SELECT
    ...
    CAST("schoolchild_or_full_time_student_indicator_3_categories_code" AS BIGINT) AS schoolchild_or_full_time_student_indicator_3_categories_code,
    "schoolchild_or_full_time_student_indicator_3_categories",
    "value"
FROM "ons-ts068"
