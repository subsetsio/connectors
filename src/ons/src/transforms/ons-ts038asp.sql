...
SELECT
    ...
    CAST("disability_equality_act_disabled_4_categories_code" AS BIGINT) AS disability_equality_act_disabled_4_categories_code,
    "disability_equality_act_disabled_4_categories",
    "value"
FROM "ons-ts038asp"
