...
SELECT
    ...
    CAST("household_language_english_and_welsh_5_categories_code" AS BIGINT) AS household_language_english_and_welsh_5_categories_code,
    "household_language_english_and_welsh_5_categories",
    "value"
FROM "ons-ts025"
