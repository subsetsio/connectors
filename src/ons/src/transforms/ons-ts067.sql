...
SELECT
    ...
    CAST("highest_level_of_qualification_8_categories_code" AS BIGINT) AS highest_level_of_qualification_8_categories_code,
    "highest_level_of_qualification_8_categories",
    "value"
FROM "ons-ts067"
