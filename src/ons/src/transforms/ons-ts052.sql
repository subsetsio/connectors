...
SELECT
    ...
    CAST("occupancy_rating_for_bedrooms_6_categories_code" AS BIGINT) AS occupancy_rating_for_bedrooms_6_categories_code,
    "occupancy_rating_for_bedrooms_6_categories",
    "value"
FROM "ons-ts052"
