...
SELECT
    ...
    CAST("proficiency_in_english_language_6_categories_code" AS BIGINT) AS proficiency_in_english_language_6_categories_code,
    "proficiency_in_english_language_6_categories",
    "value"
FROM "ons-ts029"
