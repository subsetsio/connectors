...
SELECT
    ...
    CAST("uk_armed_forces_veteran_indicator_5_categories_code" AS BIGINT) AS uk_armed_forces_veteran_indicator_5_categories_code,
    "uk_armed_forces_veteran_indicator_5_categories",
    "value"
FROM "ons-ts071"
