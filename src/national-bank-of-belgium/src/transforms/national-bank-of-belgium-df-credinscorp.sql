...
SELECT
    ...
    "FREQ" AS freq,
    "CREDINSCORP_ITEM" AS credinscorp_item,
    "CREDINSCORP_TYPE" AS credinscorp_type,
    "CREDINSCORP_CURR" AS credinscorp_curr,
    "TIME_PERIOD" AS time_period,
    "OBS_VALUE" AS obs_value,
    "OBS_STATUS" AS obs_status,
    CAST("DECIMALS" AS BIGINT) AS decimals
FROM "national-bank-of-belgium-df-credinscorp"
