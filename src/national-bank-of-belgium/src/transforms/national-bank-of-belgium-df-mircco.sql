...
SELECT
    ...
    "FREQ" AS freq,
    "MIRCCO_AREA" AS mircco_area,
    CAST("MIRCCO_SECTOR" AS BIGINT) AS mircco_sector,
    "MIRCCO_INSTRUMENT" AS mircco_instrument,
    "MIRCCO_MATURITY" AS mircco_maturity,
    strptime("TIME_PERIOD", '%Y-%m')::DATE AS time_period,
    CAST("OBS_VALUE" AS DOUBLE) AS obs_value,
    "OBS_STATUS" AS obs_status,
    CAST("DECIMALS" AS BIGINT) AS decimals
FROM "national-bank-of-belgium-df-mircco"
