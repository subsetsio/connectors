...
SELECT
    ...
    "FREQ" AS freq,
    "MIR_ITEM" AS mir_item,
    "MIR_SECTOR" AS mir_sector,
    "MIR_INSTRUMENT" AS mir_instrument,
    "MIR_MATURITY" AS mir_maturity,
    "MIR_QUARTILE" AS mir_quartile,
    "MIR_FACTOR" AS mir_factor,
    strptime("TIME_PERIOD", '%Y-%m')::DATE AS time_period,
    CAST("OBS_VALUE" AS DOUBLE) AS obs_value,
    "OBS_STATUS" AS obs_status,
    CAST("DECIMALS" AS BIGINT) AS decimals
FROM "national-bank-of-belgium-df-mir"
