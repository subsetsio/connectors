...
SELECT
    ...
    "FREQ" AS freq,
    "CONSTRUCTION_PERMIT" AS construction_permit,
    "CONSTRUCTION_TYPE" AS construction_type,
    "CONSTRUCTION_GEO" AS construction_geo,
    "CONSTRUCTION_ITEM" AS construction_item,
    strptime("TIME_PERIOD", '%Y-%m')::DATE AS time_period,
    "OBS_VALUE" AS obs_value,
    "OBS_STATUS" AS obs_status,
    CAST("DECIMALS" AS BIGINT) AS decimals
FROM "national-bank-of-belgium-df-construction"
