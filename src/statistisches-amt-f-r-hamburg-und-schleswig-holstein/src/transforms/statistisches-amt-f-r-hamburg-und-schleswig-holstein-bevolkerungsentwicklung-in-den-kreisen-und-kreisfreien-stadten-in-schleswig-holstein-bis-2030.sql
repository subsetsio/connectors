...
SELECT
    ...
    "column_number",
    "value_text"
FROM "statistisches-amt-f-r-hamburg-und-schleswig-holstein-bevolkerungsentwicklung-in-den-kreisen-und-kreisfreien-stadten-in-schleswig-holstein-bis-2030"
