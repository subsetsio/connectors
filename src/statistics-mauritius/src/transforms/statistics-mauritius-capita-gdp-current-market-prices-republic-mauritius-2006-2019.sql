...
SELECT
    ...
    CAST("Per_Capita_GDP_at_Current_market_price" AS BIGINT) AS per_capita_gdp_at_current_market_price,
...
FROM "statistics-mauritius-capita-gdp-current-market-prices-republic-mauritius-2006-2019"
