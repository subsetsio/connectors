...
SELECT
    ...
    "value_raw",
    "value"
FROM "kff-medicaid-behavioral-health-services-naloxone-coverage-provided-for-family-members-or-friends-obtaining-naloxone-prescription-on-enrollees-behalf"
