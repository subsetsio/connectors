...
SELECT
    ...
    "col_index",
    "metric",
    CAST("value_raw" AS BIGINT) AS value_raw,
    "value"
FROM "kff-total-social-security-disability-insurance-ssdi-beneficiaries-and-disabled-supplemental-security-income-ssi-beneficiaries-under-age-65"
