SELECT
    ...
    CAST("CON_14100092_DIM1" AS VARCHAR) AS "CON_14100092_DIM1",
    CAST("CON_14100092_DIM2" AS VARCHAR) AS "CON_14100092_DIM2",
...
FROM "canadian-centre-for-energy-information-stc:df-14100092"
