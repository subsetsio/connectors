SELECT
    ...
    CAST("CON_18100030_DIM1" AS VARCHAR) AS "CON_18100030_DIM1",
    CAST("CON_18100030_DIM2" AS VARCHAR) AS "CON_18100030_DIM2",
...
FROM "canadian-centre-for-energy-information-stc:df-18100030"
