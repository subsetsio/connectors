SELECT
    ...
    CAST("CON_25100018_DIM1" AS VARCHAR) AS "CON_25100018_DIM1",
    CAST("CON_25100018_DIM2" AS VARCHAR) AS "CON_25100018_DIM2",
...
FROM "canadian-centre-for-energy-information-stc:df-25100018"
