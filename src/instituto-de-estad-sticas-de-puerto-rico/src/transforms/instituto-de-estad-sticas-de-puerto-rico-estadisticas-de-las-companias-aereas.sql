...
SELECT
    "source_resource",
    "source_file",
    CAST("DEPARTURES_SCHEDULED" AS BIGINT) AS departures_scheduled,
    CAST("DEPARTURES_PERFORMED" AS BIGINT) AS departures_performed,
    CAST("PAYLOAD" AS BIGINT) AS payload,
    CAST("SEATS" AS BIGINT) AS seats,
    CAST("PASSENGERS" AS BIGINT) AS passengers,
    CAST("FREIGHT" AS BIGINT) AS freight,
    CAST("MAIL" AS BIGINT) AS mail,
    CAST("DISTANCE" AS BIGINT) AS distance,
    CAST("RAMP_TO_RAMP" AS BIGINT) AS ramp_to_ramp,
...
FROM "instituto-de-estad-sticas-de-puerto-rico-estadisticas-de-las-companias-aereas"
