...
SELECT
    ...
    "Caso" AS caso,
    "Trámite" AS tr_mite,
    "Fecha de Radicación" AS fecha_de_radicaci_n,
    ...
    "Fecha de Adjudicación" AS fecha_de_adjudicaci_n,
    "Siglas" AS siglas,
    "X" AS x,
    "Y" AS y,
...
FROM "instituto-de-estad-sticas-de-puerto-rico-pemas-permisos-de-uso-01-abr-2015"
