SELECT
    ...
    TimeDim                         AS time_dim,
    TimeDimensionValue              AS time_dimension_value,
    TRY_CAST(TimeDimensionBegin AS TIMESTAMP) AS time_dimension_begin,
    TRY_CAST(TimeDimensionEnd AS TIMESTAMP)   AS time_dimension_end,
