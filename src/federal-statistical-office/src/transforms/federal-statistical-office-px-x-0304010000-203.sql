...
SELECT
    ...
    CAST("suisses_suissesses_et_étrangers_étrangères" AS VARCHAR) AS "suisses_suissesses_et_étrangers_étrangères",
...
FROM "federal-statistical-office-px-x-0304010000-203"
