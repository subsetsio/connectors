...
SELECT
    ...
    "row_index",
    "col_index",
    strptime("row_label", '%Y-%m')::DATE AS row_label,
    "col_header",
    "value",
    "value_text"
FROM "banco-central-del-ecuador-documentos-informacioneconomica-sectorexterno-indiceprecios-sh-indices-precios-ce-ti"
