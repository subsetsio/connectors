...
SELECT
    ...
    "value",
    "value_text"
FROM "banco-central-del-ecuador-documentos-informacioneconomica-cuentasnacionales-regionales-cantonales-retropolaci-n-cnr-cantonal-2007-2018-pub-valores"
