...
SELECT
    ...
    CAST("FirstContactAppointments" AS BIGINT) AS firstcontactappointments,
    "FirstContactAppointmentsQF" AS firstcontactappointmentsqf,
    CAST("DidNotAttends" AS BIGINT) AS didnotattends,
    "DidNotAttendsQF" AS didnotattendsqf,
    CAST("TotalAppointments" AS BIGINT) AS totalappointments,
    "TotalAppointmentsQF" AS totalappointmentsqf,
    CAST("OpenCases" AS BIGINT) AS opencases,
    "OpenCasesQF" AS opencasesqf
FROM "public-health-scotland-child-and-adolescent-mental-health-waiting-times"
