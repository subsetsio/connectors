...
SELECT
    "KenmerkenBaanWerknemerBedrijf" AS kenmerkenbaanwerknemerbedrijf,
    ...
    "KenmerkenBaanWerknemerBedrijf_label" AS kenmerkenbaanwerknemerbedrijf_label,
    "BedrijfstakkenBranchesSBI2008_label" AS bedrijfstakkenbranchessbi2008_label,
    "Perioden_label" AS perioden_label
FROM "cbs-netherlands-81431ned"
