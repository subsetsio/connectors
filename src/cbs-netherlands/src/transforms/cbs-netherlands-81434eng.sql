...
SELECT
    ...
    "OtherCharacteristicsEmployee" AS othercharacteristicsemployee,
    "IndustryClassBranchSIC2008" AS industryclassbranchsic2008,
    "Periods" AS periods,
    "Jobs_1" AS jobs_1,
    ...
    "OtherCharacteristicsEmployee_label" AS othercharacteristicsemployee_label,
    "IndustryClassBranchSIC2008_label" AS industryclassbranchsic2008_label,
    "Periods_label" AS periods_label
FROM "cbs-netherlands-81434eng"
