...
SELECT
    ...
    "NieuweMaterieleVasteActiva_9" AS nieuwematerielevasteactiva_9,
    "BestaandeMaterieleVasteActiva_10" AS bestaandematerielevasteactiva_10,
    "VerkoopVanMaterieleVasteActiva_11" AS verkoopvanmaterielevasteactiva_11,
    "BedrijfstakkenBranchesSBI2008_label" AS bedrijfstakkenbranchessbi2008_label,
    "Perioden_label" AS perioden_label
FROM "cbs-netherlands-81352ned"
