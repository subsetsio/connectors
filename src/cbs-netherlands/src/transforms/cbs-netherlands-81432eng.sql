...
SELECT
    ...
    "SizeOfCompany" AS sizeofcompany,
    "IndustryClassesBranchesSIC2008" AS industryclassesbranchessic2008,
    "Periods" AS periods,
    "Jobs_1" AS jobs_1,
    ...
    "SizeOfCompany_label" AS sizeofcompany_label,
    "IndustryClassesBranchesSIC2008_label" AS industryclassesbranchessic2008_label,
    "Periods_label" AS periods_label
FROM "cbs-netherlands-81432eng"
