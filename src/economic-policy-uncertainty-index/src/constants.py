# Auto-derived from the rank-accepted entity union. eid -> source data file under /media/.
# Data, not logic: which policyuncertainty.com files we publish (one table per file).
ENTITY_FILES = {
...
ENTITY_IDS = list(ENTITY_FILES.keys())
