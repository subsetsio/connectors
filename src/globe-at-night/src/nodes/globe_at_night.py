...
TRANSFORM_SPECS = [
    SqlNodeSpec(
        id="globe-at-night-observations-transform",
        deps=["globe-at-night-observations"],
        sql='''
            SELECT
                ...
                TRY_CAST(elevation_m AS DOUBLE)                 AS elevation_m,
                ...
                NULLIF(TRY_CAST(limiting_mag AS INTEGER), -9999) AS limiting_mag,
                NULLIF(TRY_CAST(sqm_reading AS DOUBLE), -9999)   AS sqm_reading,
