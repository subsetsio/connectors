...
-- caution: Presidential precinct returns include detailed candidate and reporting-mode fields; aggregate only within a consistent geography and mode.
SELECT
    ...
    "candidate_icpsr",
    "candidate_maplight"
FROM "mit-election-lab-dvn-lywx3d"
