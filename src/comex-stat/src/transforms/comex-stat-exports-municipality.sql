-- comex-stat-exports-municipality: monthly Brazilian trade at exporter-municipality and HS-4 detail, with country/municipality/product labels joined in
...
FROM "comex-stat-exports-municipality" f
LEFT JOIN (
