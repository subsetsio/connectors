-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-fire-and-rescue-incident-statistics-year-ending-june-2025`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-fire-and-rescue-incident-statistics-year-ending-june-2025"
