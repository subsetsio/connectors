-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-planning-applications-in-england-april-to-june-2024`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-planning-applications-in-england-april-to-june-2024"
