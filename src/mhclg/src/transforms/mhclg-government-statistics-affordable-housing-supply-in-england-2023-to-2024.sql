-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-affordable-housing-supply-in-england-2023-to-2024`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-affordable-housing-supply-in-england-2023-to-2024"
