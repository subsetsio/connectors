-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-local-authority-housing-statistics-technical-notes-2023-to-2024`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-local-authority-housing-statistics-technical-notes-2023-to-2024"
