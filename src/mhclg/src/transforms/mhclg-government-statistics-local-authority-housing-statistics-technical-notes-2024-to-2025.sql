-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-local-authority-housing-statistics-technical-notes-2024-to-2025`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-local-authority-housing-statistics-technical-notes-2024-to-2025"
