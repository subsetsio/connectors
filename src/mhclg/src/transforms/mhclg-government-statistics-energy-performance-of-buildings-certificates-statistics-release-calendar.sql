-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-energy-performance-of-buildings-certificates-statistics-release-calendar`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-energy-performance-of-buildings-certificates-statistics-release-calendar"
