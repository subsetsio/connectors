-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-affordable-housing-supply-in-england-2024-to-2025`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-affordable-housing-supply-in-england-2024-to-2025"
