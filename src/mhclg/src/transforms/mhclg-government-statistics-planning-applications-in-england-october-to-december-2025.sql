-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-planning-applications-in-england-october-to-december-2025`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-planning-applications-in-england-october-to-december-2025"
