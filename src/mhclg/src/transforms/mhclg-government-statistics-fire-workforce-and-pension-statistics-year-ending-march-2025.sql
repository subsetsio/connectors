-- mechanical passthrough for accepted-but-empty raw asset `mhclg-government-statistics-fire-workforce-and-pension-statistics-year-ending-march-2025`.
...
SELECT
    ...
    "n_cols",
    "cells"
FROM "mhclg-government-statistics-fire-workforce-and-pension-statistics-year-ending-march-2025"
