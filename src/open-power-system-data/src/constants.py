...
ENTITY_IDS = [
    ...
    "household_data__household_data_1min_singleindex",
    ...
    "renewable_power_plants__res_plants_separated_DE_outvalidated_plants",
    "renewable_power_plants__res_plants_separated_FR_outvalidated_plants",
    "renewable_power_plants__validation_marker",
