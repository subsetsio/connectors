...
SELECT
    ...
    CAST("Mumps, Cum 2020†" AS BIGINT) AS mumps_cum_2020,
    "Mumps, Cum 2020†, flag" AS mumps_cum_2020_flag,
    ...
    CAST("Novel influenza A virus infections§, Cum 2020†" AS BIGINT) AS novel_influenza_a_virus_infections_cum_2020,
    "Novel influenza A virus infections§, Cum 2020†, flag" AS novel_influenza_a_virus_infections_cum_2020_flag,
