...
SELECT
    ...
    CAST("Nephritis, nephrotic syndrome and nephrosis (N00-N07,N17-N19,N25-N27)" AS BIGINT) AS nephritis_nephrotic_syn_and_nephrosis_n00_n07_n17_n19_n25_n27,
    CAST("Symptoms, signs and abnormal clinical and laboratory findings, not elsewhere classified (R00-R99)" AS BIGINT) AS symptoms_abnormal_findings_nec_r00_r99,
