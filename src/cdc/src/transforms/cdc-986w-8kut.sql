...
SELECT
    ...
    CAST("Cryptosporidiosis, Cum 2020†" AS BIGINT) AS cryptosporidiosis_cum_2020,
    "Cryptosporidiosis, Cum 2020†, flag" AS cryptosporidiosis_cum_2020_flag,
    ...
    CAST("Cyclosporiasis, Cum 2020†" AS BIGINT) AS cyclosporiasis_cum_2020,
    "Cyclosporiasis, Cum 2020†, flag" AS cyclosporiasis_cum_2020_flag,
