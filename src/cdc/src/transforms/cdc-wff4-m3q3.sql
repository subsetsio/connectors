...
SELECT
    ...
    "Invasive pneumococcal disease, age < 5 years§, Confirmed, Current week, flag" AS inv_pneumococcal_dis_age_5_years_conf_curr_wk_flag,
    CAST("Invasive pneumococcal disease, age < 5 years§, Confirmed, Previous 52 weeks Max†" AS BIGINT) AS inv_pneumococcal_dis_age_5_years_conf_prev_52wk_max,
    "Invasive pneumococcal disease, age < 5 years§, Confirmed, Previous 52 weeks Max†, flag" AS inv_pneumococcal_dis_age_5_years_conf_prev_52wk_max_flag,
    ...
    "Invasive pneumococcal disease, age < 5 years§, Confirmed, Cum 2021†, flag" AS inv_pneumococcal_dis_age_5_years_conf_cum_2021_flag,
    ...
    "Invasive pneumococcal disease, age < 5 years§, Confirmed, Cum 2020†, flag" AS inv_pneumococcal_dis_age_5_years_conf_cum_2020_flag,
    ...
    "Invasive pneumococcal disease, age < 5 years§, Probable, Current week, flag" AS inv_pneumococcal_dis_age_5_years_prob_curr_wk_flag,
    CAST("Invasive pneumococcal disease, age < 5 years§, Probable, Previous 52 weeks Max†" AS BIGINT) AS inv_pneumococcal_dis_age_5_years_prob_prev_52wk_max,
    "Invasive pneumococcal disease, age < 5 years§, Probable, Previous 52 weeks Max†, flag" AS inv_pneumococcal_dis_age_5_years_prob_prev_52wk_max_flag,
