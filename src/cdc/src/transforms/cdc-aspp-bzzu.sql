...
SELECT
    ...
    "Leptospirosis, Current week" AS leptospirosis_current_week,
    ...
    CAST("Leptospirosis, Cum 2022†" AS BIGINT) AS leptospirosis_cum_2022,
    "Leptospirosis, Cum 2022†, flag" AS leptospirosis_cum_2022_flag,
    ...
    CAST("Listeriosis§, Confirmed, Cum 2022†" AS BIGINT) AS listeriosis_confirmed_cum_2022,
    "Listeriosis§, Confirmed, Cum 2022†, flag" AS listeriosis_confirmed_cum_2022_flag,
    ...
    CAST("Listeriosis§, Probable,  Cum 2022†" AS BIGINT) AS listeriosis_probable_cum_2022,
    "Listeriosis§, Probable,  Cum 2022†, flag" AS listeriosis_probable_cum_2022_flag,
