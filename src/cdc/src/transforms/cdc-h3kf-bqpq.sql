...
SELECT
    ...
    CAST("Carbapenemase-producing Carbapenem-resistant enterobacteriaceae, Cum 2022†" AS BIGINT) AS carbapenemase_prod_carbapenem_resist_enterobacteriaceae_cum_2022,
    "Carbapenemase-producing Carbapenem-resistant enterobacteriaceae, Cum 2022†, flag" AS carbapenemase_prod_carbapenem_resist_enterobacteriaceae_3c4128d8,
