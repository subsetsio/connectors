...
SELECT
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Anaplasma phagocytophilum infection, Cum 2022†" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_anaplasma_phagocytophilum_infection_cum_2022,
    "Ehrlichiosis and Anaplasmosis, Anaplasma phagocytophilum infection, Cum 2022†, flag" AS ehrlichiosis_and_anaplasmosis_anaplasma_phagocytophilum_infection_cum_2022_flag,
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Ehrlichia chaffeensis infection, Cum 2022†" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_ehrlichia_chaffeensis_infection_cum_2022,
    "Ehrlichiosis and Anaplasmosis, Ehrlichia chaffeensis infection, Cum 2022†, flag" AS ehrlichiosis_and_anaplasmosis_ehrlichia_chaffeensis_infection_cum_2022_flag,
