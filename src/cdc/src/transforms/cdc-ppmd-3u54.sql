...
SELECT
    ...
    CAST("Viral hemorrhagic fevers§, Crimean-Congo hemorrhagic fever virus, Previous 52 weeks Max†" AS BIGINT) AS viral_hem_fevers_crimean_congo_hem_fever_virus_prev_52wk_max,
    ...
    "Viral hemorrhagic fevers§, Crimean-Congo hemorrhagic fever virus, Cum 2020†" AS viral_hem_fevers_crimean_congo_hem_fever_virus_cum_2020,
    "Viral hemorrhagic fevers§, Crimean-Congo hemorrhagic fever virus, Cum 2020†, flag" AS viral_hem_fevers_crimean_congo_hem_fever_virus_cum_2020_flag,
