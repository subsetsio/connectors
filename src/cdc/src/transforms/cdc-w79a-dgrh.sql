...
SELECT
    ...
    "Hemolytic uremic snydrome post-diarrheal, Cum 2020†, flag" AS hemolytic_uremic_snydrome_post_diarrheal_cum_2020_flag,
    ...
    CAST("Hepatitis A, acute, Cum 2020†" AS BIGINT) AS hepatitis_a_acute_cum_2020,
    "Hepatitis A, acute, Cum 2020†, flag" AS hepatitis_a_acute_cum_2020_flag,
    ...
    CAST("Hepatitis B, acute, Cum 2020†" AS BIGINT) AS hepatitis_b_acute_cum_2020,
    "Hepatitis B, acute, Cum 2020†, flag" AS hepatitis_b_acute_cum_2020_flag,
