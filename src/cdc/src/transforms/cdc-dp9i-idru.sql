...
SELECT
    ...
    CAST("Haemophilus influenza, invasive disease, All ages, all serotypes, Cum 2020†" AS BIGINT) AS haemophilus_influenza_invasive_disease_all_ages_all_serotypes_cum_2020,
    "Haemophilus influenza, invasive disease, All ages, all serotypes, Cum 2020†, flag" AS haemophilus_influenza_invasive_disease_all_ages_all_serotypes_cum_2020_flag,
    ...
    CAST("Haemophilus influenza, invasive disease, Age <5 years, Serotype b, Cum 2020†" AS BIGINT) AS haemophilus_influenza_invasive_disease_age_5_years_serotype_b_cum_2020,
    "Haemophilus influenza, invasive disease, Age <5 years, Serotype b, Cum 2020†, flag" AS haemophilus_influenza_invasive_disease_age_5_years_serotype_b_cum_2020_flag,
