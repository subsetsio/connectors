...
SELECT
    ...
    CAST("Haemophilus influenza, invasive disease, Age <5 years, Non-b serotype, Cum 2020†" AS BIGINT) AS haemophilus_influenza_invasive_disease_age_5_years_non_b_serotype_cum_2020,
    "Haemophilus influenza, invasive disease, Age <5 years, Non-b serotype, Cum 2020†, flag" AS haemophilus_influenza_invasive_disease_age_5_years_non_b_serotype_cum_2020_flag,
    CAST("Haemophilus influenza, invasive disease, Age <5 years, Nontypeable, Current week" AS BIGINT) AS haemophilus_influenza_invasive_disease_age_5_years_nontypeable_current_week,
    ...
    CAST("Haemophilus influenza, invasive disease, Age <5 years, Nontypeable, Cum 2020†" AS BIGINT) AS haemophilus_influenza_invasive_disease_age_5_years_nontypeable_cum_2020,
    "Haemophilus influenza, invasive disease, Age <5 years, Nontypeable, Cum 2020†, flag" AS haemophilus_influenza_invasive_disease_age_5_years_nontypeable_cum_2020_flag,
    ...
    CAST("Haemophilus influenza, invasive disease, Age <5 years, Unknown serotype, Cum 2020†" AS BIGINT) AS haemophilus_influenza_invasive_disease_age_5_years_unknown_serotype_cum_2020,
    "Haemophilus influenza, invasive disease, Age <5 years, Unknown serotype, Cum 2020†, flag" AS haemophilus_influenza_invasive_disease_age_5_years_unknown_serotype_cum_2020_flag,
