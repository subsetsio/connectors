...
SELECT
    ...
    CAST("Hepatitis B, perinatal infection, Current week" AS BIGINT) AS hepatitis_b_perinatal_infection_current_week,
    ...
    CAST("Hepatitis B, perinatal infection, Cum 2020†" AS BIGINT) AS hepatitis_b_perinatal_infection_cum_2020,
    "Hepatitis B, perinatal infection, Cum 2020†, flag" AS hepatitis_b_perinatal_infection_cum_2020_flag,
    ...
    CAST("Hepatitis C, acute§, Confirmed, Cum 2020†" AS BIGINT) AS hepatitis_c_acute_confirmed_cum_2020,
    "Hepatitis C, acute§, Confirmed, Cum 2020†, flag" AS hepatitis_c_acute_confirmed_cum_2020_flag,
    ...
    CAST("Hepatitis C, acute§, Probable, Cum 2020†" AS BIGINT) AS hepatitis_c_acute_probable_cum_2020,
    "Hepatitis C, acute§, Probable, Cum 2020†, flag" AS hepatitis_c_acute_probable_cum_2020_flag,
