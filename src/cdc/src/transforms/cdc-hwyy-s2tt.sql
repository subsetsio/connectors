...
SELECT
    ...
    CAST("Carbapenemase-producing Carbapenem-resistant enterobacteriaceae§, Cum 2020†" AS BIGINT) AS carbapenemase_producing_carbapenem_resistant_enterobacteriaceae_cum_2020,
    "Carbapenemase-producing Carbapenem-resistant enterobacteriaceae§, Cum 2020†, flag" AS carbapenemase_producing_carbapenem_resistant_enterobacteriaceae_cum_2020_flag,
