...
SELECT
    "dhds_test_row_3",
    CAST("2021" AS BIGINT) AS year_2021,
    "HHS6" AS hhs6,
    ...
    CAST("29.4" AS DOUBLE) AS value_29_4,
    CAST("29.4_1" AS DOUBLE) AS value_29_4_1,
    "column12",
    "column13",
    CAST("28.3" AS DOUBLE) AS value_28_3,
    CAST("30.5" AS DOUBLE) AS value_30_5,
    CAST("11208" AS BIGINT) AS count_11208,
    CAST("9290557" AS BIGINT) AS count_9290557,
    "Overall" AS overall,
