...
SELECT
    ...
    CAST("Dengue virus infections, Dengue, Cum 2022†" AS BIGINT) AS dengue_virus_infections_dengue_cum_2022,
    "Dengue virus infections, Dengue, Cum 2022†, flag" AS dengue_virus_infections_dengue_cum_2022_flag,
    ...
    CAST("Dengue virus infections, Dengue-like illness, Previous 52 weeks Max†" AS BIGINT) AS dengue_infs_dengue_like_prev_52wk_max,
    "Dengue virus infections, Dengue-like illness, Previous 52 weeks Max†, flag" AS dengue_infs_dengue_like_prev_52wk_max_flag,
    CAST("Dengue virus infections, Dengue-like illness, Cum 2022†" AS BIGINT) AS dengue_virus_infections_dengue_like_illness_cum_2022,
    "Dengue virus infections, Dengue-like illness, Cum 2022†, flag" AS dengue_virus_infections_dengue_like_illness_cum_2022_flag,
    ...
    CAST("Dengue virus infections, Severe dengue,  Cum 2022†" AS BIGINT) AS dengue_virus_infections_severe_dengue_cum_2022,
    "Dengue virus infections, Severe dengue,  Cum 2022†, flag" AS dengue_virus_infections_severe_dengue_cum_2022_flag,
