...
SELECT
    ...
    CAST("Arboviral diseases, Chikungunya virus disease, Previous 52 weeks Max†" AS BIGINT) AS arbo_dis_chik_virus_dis_prev_52wk_max,
    "Arboviral diseases,Chikungunya virus disease, Previous 52 weeks Max†, flag" AS arbo_dis_chik_virus_dis_prev_52wk_max_flag,
    ...
    "Arboviral diseases, Eastern equine encephalitis virus disease, Current week" AS arbo_dis_east_equine_enceph_virus_dis_curr_wk,
    "Arboviral diseases, Eastern equine encephalitis virus disease, Current week, flag" AS arbo_dis_east_equine_enceph_virus_dis_curr_wk_flag,
    CAST("Arboviral diseases, Eastern equine encephalitis virus disease, Previous 52 weeks Max†" AS BIGINT) AS arbo_dis_east_equine_enceph_virus_dis_prev_52wk_max,
    "Arboviral diseases, Eastern equine encephalitis virus disease, Previous 52 weeks Max†, flag" AS arbo_dis_east_equine_enceph_virus_dis_prev_52wk_max_flag,
    CAST("Arboviral diseases, Eastern equine encephalitis virus disease, Cum 2021†" AS BIGINT) AS arbo_dis_east_equine_enceph_virus_dis_cum_2021,
    "Arboviral diseases,Eastern equine encephalitis virus disease, Cum 2021†, flag" AS arbo_dis_east_equine_enceph_virus_dis_cum_2021_flag,
    CAST("Arboviral diseases, Eastern equine encephalitis virus disease, Cum 2020†" AS BIGINT) AS arbo_dis_east_equine_enceph_virus_dis_cum_2020,
    "Arboviral diseases, Eastern equine encephalitis virus disease, Cum 2020†, flag" AS arbo_dis_east_equine_enceph_virus_dis_cum_2020_flag,
