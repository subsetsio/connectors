...
SELECT
    ...
    CAST("Toxic shock snydrome (other than Streptococcal), Previous 52 weeks Max†" AS BIGINT) AS toxic_shock_syn_not_strep_prev_52wk_max,
    "Toxic shock snydrome (other than Streptococcal), Previous 52 weeks Max†, flag" AS toxic_shock_syn_not_strep_prev_52wk_max_flag,
