...
SELECT
    ...
    CAST("Botulism, Foodborne, Current week" AS BIGINT) AS botulism_foodborne_current_week,
    ...
    CAST("Botulism, Foodborne, Cum 2020†" AS BIGINT) AS botulism_foodborne_cum_2020,
    "Botulism, Foodborne, Cum 2020†, flag" AS botulism_foodborne_cum_2020_flag,
    CAST("Botulism, Infant, Current week" AS BIGINT) AS botulism_infant_current_week,
    ...
    CAST("Botulism, Infant, Cum 2020†" AS BIGINT) AS botulism_infant_cum_2020,
    "Botulism, Infant, Cum 2020†, flag" AS botulism_infant_cum_2020_flag,
    CAST("Botulism, Other (wound and unspecified), Current week" AS BIGINT) AS botulism_other_wound_and_unspecified_current_week,
    ...
    CAST("Botulism, Other (wound and unspecified), Cum 2020†" AS BIGINT) AS botulism_other_wound_and_unspecified_cum_2020,
    "Botulism, Other (wound and unspecified), Cum 2020†, flag" AS botulism_other_wound_and_unspecified_cum_2020_flag,
