...
SELECT
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Ehrlichia ewingii infection, Current week" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_ehrlichia_ewingii_infection_current_week,
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Ehrlichia ewingii infection, Cum 2021†" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_ehrlichia_ewingii_infection_cum_2021,
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Ehrlichia ewingii infection, Cum 2020†" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_ehrlichia_ewingii_infection_cum_2020,
    "Ehrlichiosis and Anaplasmosis, Ehrlichia ewingii infection, Cum 2020†, flag" AS ehrlichiosis_and_anaplasmosis_ehrlichia_ewingii_infection_cum_2020_flag,
    CAST("Ehrlichiosis and Anaplasmosis, Undetermined ehrlichiosis/anaplasmosis, Current week" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_undetermined_ehrlichiosis_anaplasmosis_current_week,
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Undetermined ehrlichiosis/anaplasmosis, Cum 2020†" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_undetermined_ehrlichiosis_anaplasmosis_cum_2020,
    "Ehrlichiosis and Anaplasmosis, Undetermined ehrlichiosis/anaplasmosis, Cum 2020†, flag" AS ehrlichiosis_and_anaplasmosis_undetermined_ehrlichiosis_anaplasmosis_cum_2020_flag,
