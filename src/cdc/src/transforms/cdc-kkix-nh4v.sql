...
SELECT
    ...
    CAST("Q fever, Total, Cum 2022†" AS BIGINT) AS q_fever_total_cum_2022,
    "Q fever, Total, Cum 2022†, flag" AS q_fever_total_cum_2022_flag,
    ...
    CAST("Q fever, Acute, Cum 2022†" AS BIGINT) AS q_fever_acute_cum_2022,
    "Q fever, Acute, Cum 2022†, flag" AS q_fever_acute_cum_2022_flag,
    ...
    "Q fever, Chronic, Current week" AS q_fever_chronic_current_week,
    ...
    "Q fever, Chronic, Cum 2022†" AS q_fever_chronic_cum_2022,
    "Q fever, Chronic, Cum 2022†, flag" AS q_fever_chronic_cum_2022_flag,
