...
SELECT
    ...
    CAST("Invasive pneumococcal disease, all ages§, Confirmed, Cum 2022†" AS BIGINT) AS invasive_pneumococcal_disease_all_ages_confirmed_cum_2022,
    "Invasive pneumococcal disease, all ages§, Confirmed, Cum 2022†, flag" AS invasive_pneumococcal_disease_all_ages_confirmed_cum_2022_flag,
    ...
    CAST("Invasive pneumococcal disease, all ages§, Probable,  Cum 2022†" AS BIGINT) AS invasive_pneumococcal_disease_all_ages_probable_cum_2022,
    "Invasive pneumococcal disease, all ages§, Probable,  Cum 2022†, flag" AS invasive_pneumococcal_disease_all_ages_probable_cum_2022_flag,
