...
SELECT
    ...
    "Vancomycin-intermediate Staphylococcus aureus, Current week" AS vancomycin_intermediate_staphylococcus_aureus_current_week,
    ...
    CAST("Vancomycin-intermediate Staphylococcus aureus, Previous 52 weeks Max†" AS BIGINT) AS vancomycin_intermediate_staph_aureus_prev_52wk_max,
    "Vancomycin-intermediate Staphylococcus aureus, Previous 52 weeks Max†, flag" AS vancomycin_intermediate_staph_aureus_prev_52wk_max_flag,
    "Vancomycin-intermediate Staphylococcus aureus, Cum 2022†" AS vancomycin_intermediate_staphylococcus_aureus_cum_2022,
    "Vancomycin-intermediate Staphylococcus aureus, Cum 2022†, flag" AS vancomycin_intermediate_staphylococcus_aureus_cum_2022_flag,
    ...
    "Vancomycin-resistant Staphylococcus aureus, Previous 52 weeks Max†, flag" AS vancomycin_resist_staph_aureus_prev_52wk_max_flag,
    "Vancomycin-resistant Staphylococcus aureus, Cum 2022†" AS vancomycin_resistant_staphylococcus_aureus_cum_2022,
    "Vancomycin-resistant Staphylococcus aureus, Cum 2022†, flag" AS vancomycin_resistant_staphylococcus_aureus_cum_2022_flag,
    "Vancomycin-resistant Staphylococcus aureus, Cum 2021†" AS vancomycin_resistant_staphylococcus_aureus_cum_2021,
    ...
    CAST("Varicella morbidity, Cum 2022†" AS BIGINT) AS varicella_morbidity_cum_2022,
    "Varicella morbidity, Cum 2022†, flag" AS varicella_morbidity_cum_2022_flag,
