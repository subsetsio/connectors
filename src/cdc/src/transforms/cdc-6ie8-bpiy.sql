...
SELECT
    ...
    CAST("Syphilis, Congenital, Cum 2020†" AS BIGINT) AS syphilis_congenital_cum_2020,
    "Syphilis, Congenital, Cum 2020†, flag" AS syphilis_congenital_cum_2020_flag,
    ...
    CAST("Syphilis, Primary and secondary, Cum 2020†" AS BIGINT) AS syphilis_primary_and_secondary_cum_2020,
    "Syphilis, Primary and secondary, Cum 2020†, flag" AS syphilis_primary_and_secondary_cum_2020_flag,
