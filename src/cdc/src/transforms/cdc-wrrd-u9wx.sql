...
SELECT
    ...
    "Meningococcal disease, Other serogroups, Previous 52 weeks Max†, flag" AS meningococcal_dis_other_serogroups_prev_52wk_max_flag,
    CAST("Meningococcal disease, Other serogroups, Cum 2022†" AS BIGINT) AS meningococcal_disease_other_serogroups_cum_2022,
    "Meningococcal disease, Other serogroups, Cum 2022†, flag" AS meningococcal_disease_other_serogroups_cum_2022_flag,
    ...
    "Meningococcal disease, Unknown serogroup, Previous 52 weeks Max†, flag" AS meningococcal_dis_unknown_serogroup_prev_52wk_max_flag,
    CAST("Meningococcal disease, Unknown serogroup, Cum 2022†" AS BIGINT) AS meningococcal_disease_unknown_serogroup_cum_2022,
    "Meningococcal disease, Unknown serogroup, Cum 2022†, flag" AS meningococcal_disease_unknown_serogroup_cum_2022_flag,
