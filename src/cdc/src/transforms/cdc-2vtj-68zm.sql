...
SELECT
    ...
    CAST("Salmonella Paratyphi infection§, Current week" AS BIGINT) AS salmonella_paratyphi_infection_current_week,
    ...
    CAST("Salmonella Paratyphi infection§, Cum 2020†" AS BIGINT) AS salmonella_paratyphi_infection_cum_2020,
    "Salmonella Paratyphi infection§, Cum 2020†, flag" AS salmonella_paratyphi_infection_cum_2020_flag,
    CAST("Salmonella Typhi infection¶, Current week" AS BIGINT) AS salmonella_typhi_infection_current_week,
    ...
    CAST("Salmonella Typhi infection¶, Cum 2020†" AS BIGINT) AS salmonella_typhi_infection_cum_2020,
    "Salmonella Typhi infection¶, Cum 2020†, flag" AS salmonella_typhi_infection_cum_2020_flag,
    ...
    CAST("Salmonellosis (excluding Salmonella Typhi infection and Salmonella Paratyphi infection)**, Cum 2020†" AS BIGINT) AS salmonellosis_excluding_salmonella_typhi_infection_and_salmonella_paratyphi_infection_cum_2020,
    "Salmonellosis (excluding Salmonella Typhi infection and Salmonella Paratyphi infection)**, Cum 2020†, flag" AS salmonellosis_excluding_salmonella_typhi_infection_and_salmonella_paratyphi_infection_cum_2020_flag,
