...
SELECT
    ...
    CAST("Salmonellosis (excluding Salmonella Typhi infection and Salmonella Paratyphi infection)**, Cum 2020†" AS BIGINT) AS salmonella_excluding_s_typhi_inf_and_s_paratyphi_inf_cum_2020,
    "Salmonellosis (excluding Salmonella Typhi infection and Salmonella Paratyphi infection)**, Cum 2020†, flag" AS salmonella_excluding_s_typhi_inf_and_s_paratyphi_inf_cu_53aa9e32,
