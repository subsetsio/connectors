...
SELECT
    ...
    CAST("Rabies, Animal, Cum 2020†" AS BIGINT) AS rabies_animal_cum_2020,
    "Rabies, Animal, Cum 2020†, flag" AS rabies_animal_cum_2020_flag,
    ...
    CAST("Rabies, Human, Cum 2021†" AS BIGINT) AS rabies_human_cum_2021,
    "Rabies, Human, Cum 2021†, flag" AS rabies_human_cum_2021_flag,
    "Rabies, Human, Cum 2020†" AS rabies_human_cum_2020,
    "Rabies, Human, Cum 2020†, flag" AS rabies_human_cum_2020_flag,
