...
SELECT
    ...
    CAST("Cholera, Current week" AS BIGINT) AS cholera_current_week,
    ...
    CAST("Cholera, Cum 2021†" AS BIGINT) AS cholera_cum_2021,
    "Cholera, Cum 2021†, flag" AS cholera_cum_2021_flag,
    CAST("Cholera, Cum 2020†" AS BIGINT) AS cholera_cum_2020,
    "Cholera, Cum 2020†, flag" AS cholera_cum_2020_flag,
    ...
    CAST("Coccidioidomycosis, Cum 2020†" AS BIGINT) AS coccidioidomycosis_cum_2020,
    "Coccidioidomycosis, Cum 2020†, flag" AS coccidioidomycosis_cum_2020_flag,
