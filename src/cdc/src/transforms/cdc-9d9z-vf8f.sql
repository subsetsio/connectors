...
SELECT
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Anaplasma phagocytophilum infection, Cum 2020†" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_anaplasma_phagocytophilum_38d2a5e7,
    "Ehrlichiosis and Anaplasmosis, Anaplasma phagocytophilum infection, Cum 2020†, flag" AS ehrlichiosis_and_anaplasmosis_anaplasma_phagocytophilum_4d76249d,
    ...
    CAST("Ehrlichiosis and Anaplasmosis, Ehrlichia chaffeensis infection, Cum 2020†" AS BIGINT) AS ehrlichiosis_and_anaplasmosis_ehrlichia_chaffeensis_inf_cum_2020,
    "Ehrlichiosis and Anaplasmosis, Ehrlichia chaffeensis infection, Cum 2020†, flag" AS ehrlichiosis_and_anaplasmosis_ehrlichia_chaffeensis_inf_5e42431e,
