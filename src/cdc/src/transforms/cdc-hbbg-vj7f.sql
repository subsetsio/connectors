...
SELECT
    ...
    CAST("Meningococcal disease, All serogroups, Cum 2020†" AS BIGINT) AS meningococcal_disease_all_serogroups_cum_2020,
    "Meningococcal disease, All serogroups, Cum 2020†, flag" AS meningococcal_disease_all_serogroups_cum_2020_flag,
    CAST("Meningococcal disease, Serogroups ACWY, Current week" AS BIGINT) AS meningococcal_disease_serogroups_acwy_current_week,
    ...
    CAST("Meningococcal disease, Serogroups ACWY, Cum 2020†" AS BIGINT) AS meningococcal_disease_serogroups_acwy_cum_2020,
    "Meningococcal disease, Serogroups ACWY, Cum 2020†, flag" AS meningococcal_disease_serogroups_acwy_cum_2020_flag,
    CAST("Meningococcal disease, Serogroup B, Current week" AS BIGINT) AS meningococcal_disease_serogroup_b_current_week,
    ...
    CAST("Meningococcal disease, Serogroup B, Cum 2020†" AS BIGINT) AS meningococcal_disease_serogroup_b_cum_2020,
    "Meningococcal disease, Serogroup B, Cum 2020†, flag" AS meningococcal_disease_serogroup_b_cum_2020_flag,
