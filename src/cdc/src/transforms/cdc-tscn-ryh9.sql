...
SELECT
    ...
    CAST("Number of COVID-19 Positive Residents Up To Date with COVID-19 Vaccines" AS BIGINT) AS number_of_covid_19_positive_res_up_to_date_with_covid_19_vax,
    CAST("Number of Hospitalized COVID-19 Positive Residents" AS BIGINT) AS number_of_hospitalized_covid_19_positive_residents,
    CAST("Number of Hospitalized COVID-19 Positive Residents Up To Date with COVID-19 Vaccines" AS BIGINT) AS number_of_hosp_covid_19_positive_res_up_to_date_with_co_8eecd218,
    ...
    CAST("Number of Influenza Positive Residents who have received Influenza Vaccine" AS BIGINT) AS number_of_flu_positive_res_who_have_received_flu_vax,
    ...
    CAST("Number of Hospitalized Influenza Positive Residents who have received Influenza Vaccine" AS BIGINT) AS number_of_hosp_flu_positive_res_who_have_received_flu_vax,
    ...
    CAST("Number of Hospitalized RSV Positive Residents who have received RSV Vaccine" AS BIGINT) AS number_of_hosp_rsv_positive_res_who_have_received_rsv_vax,
