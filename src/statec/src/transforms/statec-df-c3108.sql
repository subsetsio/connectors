...
SELECT
    ...
    "DIPLOMAS: Diplomas" AS diplomas_diplomas,
    ...
    "NOTE_DIPLOMAS_2: Note Diplomas 2" AS note_diplomas_2_note_diplomas_2,
    "NOTE_DIPLOMAS_1: Note Diplomas 1" AS note_diplomas_1_note_diplomas_1,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals
FROM "statec-df-c3108"
