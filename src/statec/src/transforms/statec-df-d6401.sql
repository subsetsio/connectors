...
SELECT
    ...
    "NOTE_DIRECTION_2: Note Direction 2" AS note_direction_2_note_direction_2,
    "NOTE_DIRECTION_1: Note Direction 1" AS note_direction_1_note_direction_1
FROM "statec-df-d6401"
