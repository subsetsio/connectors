...
SELECT
    ...
    "FEDERATION: Federation" AS federation_federation,
    ...
    "NOTE_FEDERATION_2: Note Federation 2" AS note_federation_2_note_federation_2,
    "NOTE_FEDERATION_1: Note Federation 1" AS note_federation_1_note_federation_1,
