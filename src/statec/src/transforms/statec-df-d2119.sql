...
SELECT
    ...
    "SPECIFICATION: Fruit" AS specification_fruit,
    ...
    "NOTE_SPECIFICATION_2: Note 2" AS note_specification_2_note_2,
    "NOTE_SPECIFICATION_1: Note 1" AS note_specification_1_note_1,
