...
SELECT
    ...
    "EU_NORM: EU Norm" AS eu_norm_eu_norm,
    "SPECIFICATION: Specification" AS specification_specification,
    "TIME_PERIOD: Time period" AS time_period_time_period,
    "OBS_VALUE" AS obs_value,
    "NOTE_NORM_3: Note EU Norm" AS note_norm_3_note_eu_norm,
    "NOTE_NORM_2: Note EU Norm" AS note_norm_2_note_eu_norm,
    "NOTE_NORM_1: Note EU Norm" AS note_norm_1_note_eu_norm,
