...
SELECT
    ...
    "DISTRIBUTION: Distribution" AS distribution_distribution,
    "SPECIFICATION: Specification" AS specification_specification,
    "TIME_PERIOD: Time period" AS time_period_time_period,
    "OBS_VALUE" AS obs_value,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals,
    "NOTE_DISTRIBUTION_2: Note Distribution 2" AS note_distribution_2_note_distribution_2,
    "NOTE_DISTRIBUTION_1: Note Distribution 1" AS note_distribution_1_note_distribution_1,
