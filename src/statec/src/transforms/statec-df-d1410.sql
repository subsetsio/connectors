...
SELECT
    ...
    "PROFESSION: Profession" AS profession_profession,
    ...
    "NOTE_PROFESSION_2: Note Profession 2" AS note_profession_2_note_profession_2,
    "NOTE_PROFESSION_1: Note Profession 1" AS note_profession_1_note_profession_1,
