...
SELECT
    ...
    "EMPLOYMENT: Employment" AS employment_employment,
    ...
    "NOTE_EMPLOYMENT_2: Note Employment 2" AS note_employment_2_note_employment_2,
    "NOTE_EMPLOYMENT_1: Note Employment 1" AS note_employment_1_note_employment_1
FROM "statec-df-b3102"
