...
SELECT
    ...
    "DISTRICT_COURT: District court" AS district_court_district_court,
    ...
    "NOTE_DISTRICT_COURT_2: Note District court 2" AS note_district_court_2_note_district_court_2,
    "NOTE_DISTRICT_COURT_1: Note District court 1" AS note_district_court_1_note_district_court_1
FROM "statec-df-c5300"
