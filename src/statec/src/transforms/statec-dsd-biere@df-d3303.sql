...
SELECT
    ...
    "COMMENT_TS_MESURE: Detailed description of the group of series measure" AS comment_ts_mesure_detailed_description_of_the_group_of_series_measure
FROM "statec-dsd-biere@df-d3303"
