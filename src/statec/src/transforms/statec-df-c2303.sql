...
SELECT
    ...
    "NOTE_AMOUNT_2: Note Amount 2" AS note_amount_2_note_amount_2,
    "NOTE_AMOUNT_1: Note Amount 1" AS note_amount_1_note_amount_1,
    "NOTE_PERIOD_2: Note Period 2" AS note_period_2_note_period_2,
    "NOTE_PERIOD_1: Note Period 1" AS note_period_1_note_period_1,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals
FROM "statec-df-c2303"
