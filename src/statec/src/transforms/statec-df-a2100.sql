...
SELECT
    ...
    "AVERAGE: Average" AS average_average,
    ...
    "NOTE_AVERAGE_2: Note Average 2" AS note_average_2_note_average_2,
    "NOTE_AVERAGE_1: Note Average 1" AS note_average_1_note_average_1,
