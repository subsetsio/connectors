...
SELECT
    ...
    "BALANCE_SHEET: Balance sheet" AS balance_sheet_balance_sheet,
    "SPECIFICATION: Specification" AS specification_specification,
    "TIME_PERIOD: Time period" AS time_period_time_period,
    "OBS_VALUE" AS obs_value,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals,
    "NOTE_BALANCE_SHEET_2: Note Balance sheet 2" AS note_balance_sheet_2_note_balance_sheet_2,
    "NOTE_BALANCE_SHEET_1: Note Balance sheet 1" AS note_balance_sheet_1_note_balance_sheet_1,
