...
SELECT
    ...
    "TEMPERATURE: Temperature" AS temperature_temperature,
    ...
    "NOTE_TEMPERATURE_2: Note Temperature 2" AS note_temperature_2_note_temperature_2,
    "NOTE_TEMPERATURE_1: Note Temperature 1" AS note_temperature_1_note_temperature_1,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals
FROM "statec-df-a2101"
