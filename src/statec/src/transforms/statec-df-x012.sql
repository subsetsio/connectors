...
SELECT
    ...
    "ALTITUDE: Altitude" AS altitude_altitude,
    "SPECIFICATION: Specification" AS specification_specification,
    "FREQ: Frequency" AS freq_frequency,
    "TIME_PERIOD: Time period" AS time_period_time_period,
    "OBS_VALUE" AS obs_value,
    "NOTE_ALTITUDE_2: Note Altitude 2" AS note_altitude_2_note_altitude_2,
    "NOTE_ALTITUDE_1: Note Altitude 1" AS note_altitude_1_note_altitude_1,
