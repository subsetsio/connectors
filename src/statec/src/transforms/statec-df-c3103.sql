...
SELECT
    ...
    "ACCOMMODATION: Accommodation" AS accommodation_accommodation,
    ...
    "NOTE_ACCOMMODATION_2: Note Accommodation 2" AS note_accommodation_2_note_accommodation_2,
    "NOTE_ACCOMMODATION_1: Note Accommodation 1" AS note_accommodation_1_note_accommodation_1,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals
FROM "statec-df-c3103"
