...
SELECT
    ...
    "NOTE_MEAT_2: Note meat 2" AS note_meat_2_note_meat_2,
    "NOTE_MEAT_1: Note meat 1" AS note_meat_1_note_meat_1,
    "NOTE_SPECIFICATION_2: Note spécification 2" AS note_specification_2_note_sp_cification_2,
    "NOTE_SPECIFICATION_1: Note specification 1" AS note_specification_1_note_specification_1,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals
FROM "statec-df-d2150"
