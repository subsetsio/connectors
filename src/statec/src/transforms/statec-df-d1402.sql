...
SELECT
    ...
    "LEGAL_STATUS: Legal Status" AS legal_status_legal_status,
    ...
    "NOTE_LEGAL_STATUS_2: Note Legal Status 2" AS note_legal_status_2_note_legal_status_2,
    "NOTE_LEGAL_STATUS_1: Note Legal Status 1" AS note_legal_status_1_note_legal_status_1,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals
FROM "statec-df-d1402"
