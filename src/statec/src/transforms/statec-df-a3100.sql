...
SELECT
    ...
    "CAPACITY: Capacity" AS capacity_capacity,
    "SPECIFICATION: Specification" AS specification_specification,
    "TIME_PERIOD: Time period" AS time_period_time_period,
    "OBS_VALUE" AS obs_value,
    "NOTE_CAPACITY_2: Note Capacity 2" AS note_capacity_2_note_capacity_2,
    "NOTE_CAPACITY_1: Note Capacity 1" AS note_capacity_1_note_capacity_1,
