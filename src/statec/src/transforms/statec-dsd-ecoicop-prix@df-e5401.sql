...
SELECT
    ...
    "ECOICOP_1999: Products (ECOICOP v.1)" AS ecoicop_1999_products_ecoicop_v_1,
    "BASE_PERIOD: Base period" AS base_period_base_period,
    "ECOICOP_2018: Products (ECOICOP v.2)" AS ecoicop_2018_products_ecoicop_v_2,
...
FROM "statec-dsd-ecoicop-prix@df-e5401"
