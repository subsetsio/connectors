...
SELECT
    ...
    "NOTE_DISTRICT_2: Note District 2" AS note_district_2_note_district_2,
    "NOTE_DISTRICT_1: Note District 1" AS note_district_1_note_district_1,
