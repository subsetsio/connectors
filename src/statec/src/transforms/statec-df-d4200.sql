...
SELECT
    ...
    "BUILDINGS: Buildings" AS buildings_buildings,
    ...
    "NOTE_BUILDINGS_2: Note Buildings 2" AS note_buildings_2_note_buildings_2,
    "NOTE_BUILDINGS_1: Note Buildings 1" AS note_buildings_1_note_buildings_1,
