...
SELECT
    ...
    "GROUP_OF_CRAFTS: Group of crafts" AS group_of_crafts_group_of_crafts,
    ...
    "NOTE_GROUP_OF_CRAFTS_2: Note Group of crafts 2" AS note_group_of_crafts_2_note_group_of_crafts_2,
    "NOTE_GROUP_OF_CRAFTS_1: Note Group of crafts 1" AS note_group_of_crafts_1_note_group_of_crafts_1,
    "OBS_STATUS: Observation status" AS obs_status_observation_status,
    "DECIMALS: Decimals" AS decimals_decimals
FROM "statec-df-d1400"
