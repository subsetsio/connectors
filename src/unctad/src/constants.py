...
ENTITY_IDS = [
    ...
    "US.GDPTotal", "US.Gender_DomesticValueAdded",
    "US.Gender_TradableIndustries", "US.GoodsAndServBalanceBpm6", "US.GovExpenditures",
    "US.GoodsAndServTradeOpennessBpm6", "US.GoodsAndServicesBpm6",
    "US.IFF_CrimesRelated", "US.IFF_TradeMisinvoicing",
    "US.HiddenPlasticsTradebyPartner", "US.IctProductionSector",
    "US.IctUseEconActivity", "US.IctUseEconActivity_Isic4",
    "US.IctUseEnterprSize", "US.IctUseLocation", "US.InclusiveGrowth",
    "US.IntraTrade", "US.LSBCI",
    "US.LSCI", "US.LSCI_M", "US.MerchTheilIndices", "US.MerchVolumeQuarterly",
    "US.MerchantFleet", "US.NonPlasticSubstsTradeByPartner", "US.OceanServices",
    "US.OceanTrade", "US.PCI", "US.PLSCI",
    ...
    "US.TotAndComServicesQuarterly", "US.TradeFoodCatByProc",
    "US.TradeFoodProcByCat", "US.TradeFoodProcCat_Cat_RCA",
    "US.TradeFoodProcCat_Proc_RCA", "US.TradeServCatByPartner",
    "US.TradeServCatTotal", "US.TradeServICT",
    "US.TradeMerchBalance", "US.TradeMerchGR", "US.TradeMerchTotal",
    "US.UCPI_A",
    "US.UCPI_M", "US.VesselValueByOwnership", "US.VesselValueByRegistration",
    "US.WastewaterTreatment",
]
