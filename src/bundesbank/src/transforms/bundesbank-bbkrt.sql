...
-- caution: Realtime vintage data: `file_key` is part of the row identity because the same series and period can appear in multiple release vintages.
SELECT
    "dataflow",
    "file_key",
    "frequency",
