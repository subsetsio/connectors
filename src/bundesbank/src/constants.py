...
The 84 SDMX dataflow ids the accept step accepted, enumerated by collect from
...
BBBPS and BBSF3 are deliberately absent: the metadata endpoint still listed
them previously, but the data endpoint now returns 404, so collect filters them
as non-publishable empty/retired flows.
"""
...
ENTITY_IDS = [
    ...
    "BBBS2", "BBBU2", "BBBZ1", "BBDA1", "BBDB2", "BBDE1", "BBDL1",
    ...
    "BBMFK1", "BBMMB", "BBMME", "BBMMS", "BBMMU", "BBNZ1", "BBQFS", "BBSAP",
    "BBSDI", "BBSDP", "BBSEI", "BBSF2", "BBSHI", "BBSIS", "BBSSP", "BBSSY",
