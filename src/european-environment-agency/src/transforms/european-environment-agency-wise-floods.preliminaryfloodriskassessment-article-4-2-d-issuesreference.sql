SELECT
    ...
    CAST("article_4_2_d_IssuesReference" AS VARCHAR) AS "article_4_2_d_IssuesReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-4-2-d-issuesreference"
