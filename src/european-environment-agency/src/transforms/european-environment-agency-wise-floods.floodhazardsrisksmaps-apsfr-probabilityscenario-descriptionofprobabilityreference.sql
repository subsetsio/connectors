SELECT
    ...
    CAST("descriptionOfProbabilityReference" AS VARCHAR) AS "descriptionOfProbabilityReference",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-probabilityscenario-descriptionofprobabilityreference"
