SELECT
    ...
    CAST("article_4_2_b_PastAdverseConsequencesCriteriaUsed" AS VARCHAR) AS "article_4_2_b_PastAdverseConsequencesCriteriaUsed",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-4-2-b-pastadverseconsequencescriteriaused"
