SELECT
    ...
    CAST("considerationsConsequencesMethodologyReference" AS VARCHAR) AS "considerationsConsequencesMethodologyReference",
...
FROM "european-environment-agency-wise-floods.areaofpotentialsignificantfloodrisk-methodology-considerationsconsequencesmethodologyreference"
