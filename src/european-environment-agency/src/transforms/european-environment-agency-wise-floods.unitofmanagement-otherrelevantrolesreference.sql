SELECT
    ...
    CAST("otherRelevantRolesReference" AS VARCHAR) AS "otherRelevantRolesReference"
FROM "european-environment-agency-wise-floods.unitofmanagement-otherrelevantrolesreference"
