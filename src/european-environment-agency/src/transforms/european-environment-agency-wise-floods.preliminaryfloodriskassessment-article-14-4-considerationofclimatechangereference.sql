SELECT
    ...
    CAST("article_14_4_ConsiderationOfClimateChangeReference" AS VARCHAR) AS "article_14_4_ConsiderationOfClimateChangeReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-14-4-considerationofclimatechangereference"
