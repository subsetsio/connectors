SELECT
    ...
    CAST("typeOfFloodReference" AS VARCHAR) AS "typeOfFloodReference"
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-floodeventlocation-typeoffloodreference"
