SELECT
    ...
    CAST("swDisproportionateCostAlternativeFinancing" AS VARCHAR) AS "swDisproportionateCostAlternativeFinancing",
...
FROM "european-environment-agency-wise-wfd.swmet-swexemptions-swdisproportionatecostalternativefinancing"
