SELECT
    ...
    CAST("criteriaDeterminationReference" AS VARCHAR) AS "criteriaDeterminationReference",
...
FROM "european-environment-agency-wise-floods.areaofpotentialsignificantfloodrisk-methodology-criteriadeterminationreference"
