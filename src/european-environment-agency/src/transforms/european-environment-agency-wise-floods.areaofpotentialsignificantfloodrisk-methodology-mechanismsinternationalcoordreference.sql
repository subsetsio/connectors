SELECT
    ...
    CAST("mechanismsInternationalCoordReference" AS VARCHAR) AS "mechanismsInternationalCoordReference",
...
FROM "european-environment-agency-wise-floods.areaofpotentialsignificantfloodrisk-methodology-mechanismsinternationalcoordreference"
