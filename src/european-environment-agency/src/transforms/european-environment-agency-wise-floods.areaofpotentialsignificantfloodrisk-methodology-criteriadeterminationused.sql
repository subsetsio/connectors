SELECT
    ...
    CAST("criteriaDeterminationUsed" AS VARCHAR) AS "criteriaDeterminationUsed",
...
FROM "european-environment-agency-wise-floods.areaofpotentialsignificantfloodrisk-methodology-criteriadeterminationused"
