SELECT
    ...
    CAST("costExplanationReference" AS VARCHAR) AS "costExplanationReference",
...
FROM "european-environment-agency-wise-floods.floodriskmanagementplans-measure-costexplanationreference"
