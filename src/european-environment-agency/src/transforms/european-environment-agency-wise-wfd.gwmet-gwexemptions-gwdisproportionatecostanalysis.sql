SELECT
    ...
    CAST("gwDisproportionateCostAnalysis" AS VARCHAR) AS "gwDisproportionateCostAnalysis",
...
FROM "european-environment-agency-wise-wfd.gwmet-gwexemptions-gwdisproportionatecostanalysis"
