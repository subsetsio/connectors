SELECT
    ...
    CAST("sourcesMappedReference" AS VARCHAR) AS "sourcesMappedReference"
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-sourcesmappedreference"
