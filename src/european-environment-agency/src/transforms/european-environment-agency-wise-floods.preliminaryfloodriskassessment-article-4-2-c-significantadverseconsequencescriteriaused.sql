SELECT
    ...
    CAST("article_4_2_c_SignificantAdverseConsequencesCriteriaUsed" AS VARCHAR) AS "article_4_2_c_SignificantAdverseConsequencesCriteriaUsed",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-4-2-c-significantadverseconsequencescriteriaused"
