SELECT
    ...
    CAST("article_6_7_Justification" AS VARCHAR) AS "article_6_7_Justification",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-article-6-7-justification"
