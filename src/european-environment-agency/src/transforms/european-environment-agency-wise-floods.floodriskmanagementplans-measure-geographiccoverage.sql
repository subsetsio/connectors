SELECT
    ...
    CAST("geographicCoverage" AS VARCHAR) AS "geographicCoverage",
...
FROM "european-environment-agency-wise-floods.floodriskmanagementplans-measure-geographiccoverage"
