SELECT
    ...
    CAST("internationalRelationshipsReference" AS VARCHAR) AS "internationalRelationshipsReference",
...
FROM "european-environment-agency-wise-floods.unitofmanagement-internationalrelationshipsreference"
