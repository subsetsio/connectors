SELECT
    ...
    CAST("consequencesEnvironmentReference" AS VARCHAR) AS "consequencesEnvironmentReference",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-probabilityscenario-consequencesenvironmentreference"
