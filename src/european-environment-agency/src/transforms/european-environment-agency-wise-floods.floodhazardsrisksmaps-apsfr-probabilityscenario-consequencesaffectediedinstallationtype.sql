SELECT
    ...
    CAST("consequencesAffectedIEDInstallationType" AS VARCHAR) AS "consequencesAffectedIEDInstallationType",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-probabilityscenario-consequencesaffectediedinstallationtype"
