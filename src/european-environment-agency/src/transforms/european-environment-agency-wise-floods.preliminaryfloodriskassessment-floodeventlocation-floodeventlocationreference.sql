SELECT
    ...
    CAST("floodEventLocationReference" AS VARCHAR) AS "floodEventLocationReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-floodeventlocation-floodeventlocationreference"
