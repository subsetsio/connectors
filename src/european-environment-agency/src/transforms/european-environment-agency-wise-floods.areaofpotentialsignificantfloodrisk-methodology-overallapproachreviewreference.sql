SELECT
    ...
    CAST("overallApproachReviewReference" AS VARCHAR) AS "overallApproachReviewReference",
    CAST("url" AS VARCHAR) AS "url"
FROM "european-environment-agency-wise-floods.areaofpotentialsignificantfloodrisk-methodology-overallapproachreviewreference"
