SELECT
    ...
    CAST("article_6_6_Justification" AS VARCHAR) AS "article_6_6_Justification",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-article-6-6-justification"
