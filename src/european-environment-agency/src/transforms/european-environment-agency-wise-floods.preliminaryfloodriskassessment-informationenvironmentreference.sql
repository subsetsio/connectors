SELECT
    ...
    CAST("informationEnvironmentReference" AS VARCHAR) AS "informationEnvironmentReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-informationenvironmentreference"
