SELECT
    ...
    CAST("swTechnicalInfeasibility" AS VARCHAR) AS "swTechnicalInfeasibility"
FROM "european-environment-agency-wise-wfd.swmet-swexemptions-swtechnicalinfeasibility"
