SELECT
    CAST("article_14_1_OverallApproachReviewReference" AS VARCHAR) AS "article_14_1_OverallApproachReviewReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-14-1-overallapproachreviewreference"
