SELECT
    ...
    CAST("article_4_3_InternationalInformationExchangeReference" AS VARCHAR) AS "article_4_3_InternationalInformationExchangeReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-4-3-internationalinformationexchangereference"
