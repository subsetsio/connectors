SELECT
    ...
    CAST("otherTypeOfPotentialConsequencesExplanationReference" AS VARCHAR) AS "otherTypeOfPotentialConsequencesExplanationReference",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-probabilityscenario-othertypeofpotentialconsequencesexplanationreference"
