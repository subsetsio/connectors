SELECT
    ...
    CAST("swDisproportionateCostAnalysis" AS VARCHAR) AS "swDisproportionateCostAnalysis",
...
FROM "european-environment-agency-wise-wfd.swmet-swexemptions-swdisproportionatecostanalysis"
