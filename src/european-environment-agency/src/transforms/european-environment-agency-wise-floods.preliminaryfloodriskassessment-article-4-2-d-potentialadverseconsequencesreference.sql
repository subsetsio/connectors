SELECT
    ...
    CAST("article_4_2_d_PotentialAdverseConsequencesReference" AS VARCHAR) AS "article_4_2_d_PotentialAdverseConsequencesReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-4-2-d-potentialadverseconsequencesreference"
