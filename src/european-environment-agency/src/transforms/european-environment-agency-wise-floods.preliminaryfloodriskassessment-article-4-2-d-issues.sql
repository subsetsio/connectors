SELECT
    ...
    CAST("article_4_2_d_Issues" AS VARCHAR) AS "article_4_2_d_Issues",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-4-2-d-issues"
