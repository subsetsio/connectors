SELECT
    ...
    CAST("gwTechnicalInfeasibility" AS VARCHAR) AS "gwTechnicalInfeasibility",
...
FROM "european-environment-agency-wise-wfd.gwmet-gwexemptions-gwtechnicalinfeasibility"
