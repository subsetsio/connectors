SELECT
    ...
    CAST("nationalRelationshipsReference" AS VARCHAR) AS "nationalRelationshipsReference"
FROM "european-environment-agency-wise-floods.unitofmanagement-nationalrelationshipsreference"
