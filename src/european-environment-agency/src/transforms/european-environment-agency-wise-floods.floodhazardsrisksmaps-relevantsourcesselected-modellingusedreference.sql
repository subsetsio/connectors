SELECT
    ...
    CAST("modellingUsedReference" AS VARCHAR) AS "modellingUsedReference",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-relevantsourcesselected-modellingusedreference"
