SELECT
    ...
    CAST("consequencesAffectedEnvironmentType" AS VARCHAR) AS "consequencesAffectedEnvironmentType",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-apsfr-probabilityscenario-consequencesaffectedenvironmenttype"
