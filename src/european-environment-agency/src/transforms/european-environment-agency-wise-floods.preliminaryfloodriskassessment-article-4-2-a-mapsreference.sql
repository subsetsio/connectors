SELECT
    ...
    CAST("article_4_2_a_MapsReference" AS VARCHAR) AS "article_4_2_a_MapsReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-article-4-2-a-mapsreference"
