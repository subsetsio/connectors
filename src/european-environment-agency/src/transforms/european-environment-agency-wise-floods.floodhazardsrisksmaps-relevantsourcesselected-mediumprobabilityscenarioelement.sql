SELECT
    ...
    CAST("mediumProbabilityScenarioElement" AS VARCHAR) AS "mediumProbabilityScenarioElement",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-relevantsourcesselected-mediumprobabilityscenarioelement"
