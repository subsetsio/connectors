SELECT
    ...
    CAST("informationHumanHealthSocialReference" AS VARCHAR) AS "informationHumanHealthSocialReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-informationhumanhealthsocialreference"
