SELECT
    ...
    CAST("informationEconomicActivityReference" AS VARCHAR) AS "informationEconomicActivityReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-informationeconomicactivityreference"
