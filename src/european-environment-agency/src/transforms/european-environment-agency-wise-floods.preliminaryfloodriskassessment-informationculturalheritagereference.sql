SELECT
    ...
    CAST("informationCulturalHeritageReference" AS VARCHAR) AS "informationCulturalHeritageReference",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-informationculturalheritagereference"
