SELECT
    ...
    CAST("mechanismOfFlooding" AS VARCHAR) AS "mechanismOfFlooding",
...
FROM "european-environment-agency-wise-floods.preliminaryfloodriskassessment-floodeventlocation-mechanismofflooding"
