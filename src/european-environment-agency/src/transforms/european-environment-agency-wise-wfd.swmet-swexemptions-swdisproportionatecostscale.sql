SELECT
    ...
    CAST("swDisproportionateCostScale" AS VARCHAR) AS "swDisproportionateCostScale",
    CAST("swExemptionsTransboundary" AS VARCHAR) AS "swExemptionsTransboundary"
FROM "european-environment-agency-wise-wfd.swmet-swexemptions-swdisproportionatecostscale"
