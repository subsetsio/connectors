SELECT
    ...
    CAST("highProbabilityScenarioElement" AS VARCHAR) AS "highProbabilityScenarioElement",
...
FROM "european-environment-agency-wise-floods.floodhazardsrisksmaps-relevantsourcesselected-highprobabilityscenarioelement"
