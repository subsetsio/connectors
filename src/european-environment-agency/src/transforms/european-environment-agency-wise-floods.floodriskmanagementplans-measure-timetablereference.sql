SELECT
    ...
    CAST("timetableReference" AS VARCHAR) AS "timetableReference",
    CAST("UID" AS VARCHAR) AS "UID",
    CAST("wfdMeasureCode" AS VARCHAR) AS "wfdMeasureCode"
FROM "european-environment-agency-wise-floods.floodriskmanagementplans-measure-timetablereference"
